...
(function (b) {
    ...
    function a(ax, aG) {
        ...
        var F = new Array(), aC = 0, y = 0;
        var I, Q, l, k;
        var aq, aB, aw, au, O, n, aL, aJ, aA, az, W, U, ap, al = 0;
        var h, ah;
        var aK, B = 0, z = 0, ag = 0, ae = 0, s = 0, r = 0, at = 0, ar = 0, H = 0, G = 0;
        var D = detect_old_ie(), A = /MSIE (\d+\.\d+);/.test(navigator.userAgent), Y, V;
        var K, j = "", J, t;
        ...
        function N(u, aM) {
            ...
            if (E.options.tint && (E.options.position != "inside" && E.options.position != "fullscreen")) {
                ...
                if (D) {
                    o.css({"background-image": "url(" + ax.attr("src") + ")", "background-color": "#fff"})
                }
            }
            I = new Image();
            var v = "";
