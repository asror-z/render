    ...
    function add_like(id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                } else if (($('#like-element-' + id).hasClass('text-muted'))&&
                    ($('#dislike-element-' + id).hasClass('text-success'))){
    ...
    function dis_like(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                else if (($('#like-element-' + id).hasClass('text-success'))&&
                    ($('#dislike-element-' + id).hasClass('text-muted'))){
                    data--;
                    $('#text-like-' + id).html(data);
                    $('#like-element-' + id).removeClass('text-success');
                ...
                /*if ($('#dislike-element-' + id).hasClass('text-muted')) {
                    let a=$('#text-dislike-'+id).html();
                    a+=data;
                    $('#text-dislike-' + id).html(a);
