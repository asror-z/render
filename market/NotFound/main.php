    ...
    <div class="container mt-5">
        <div class="row">
                ...
                c6.755-0.61,20.546-0.608,41.785,5.087s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"/>
                        ...
                        <g id="planet">
                            ...
                            <circle id="craterBig" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10"
                                    ...
                                    cy="62.319" r="13.074"/>
                            stroke-width="3"
                            <circle id="craterSmall" fill="none" stroke="#0E0620"
			...
			M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149"/>
                            ...
                            <g id="stars">
                                <g>
                                                <line fill="none" stroke="#0E0620"                    <g id="starsBig">
            ...
            <div class="col-md-6 align-self-center d-flex flex-column align-items-center">
                <p class="fp-30 text-muted text-center"><?= $item ?></p>
                <a href="<?= $this->urlGetBase() ?>" class="btn btn-success fp-17">Перейти на главную страницу</a>
            </div>
        </div>
    </div>
</main>
