...
?>
   <div class="container-fluid">
      <div class="row">
          ...
          <div class="d-flex">
              <h4 class="sell">Вместе с <h4 class="sellGreen">MarketPlace</h4></h4>
          </div>
             <p class="write"></p>
             <p class="mt-4"></p>
          </div>
          <div class="col-lg-6 maining d-none d-lg-block">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-6 maining">
                ...
                <div class="side">
                    <img src="/render/asrorz/images/mainBg.png" class="img-phone d-none d-lg-block" alt="">
                </div>
            </div>
        </div>
    </div>
