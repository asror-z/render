...
window = "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}, document = window.document || {}, function (a, b) {
    ...
    "use strict";
    var b = 0, c = {}, d = {}, e = window.emojione, f = [];

    function g(a) {
        e ? a() : f.push(a)
    }

    var h = "data:image/gif;base64,R0lGODlhAQABAJH/AP///wAAAMDAwAAAACH5BAEAAAIALAAAAAABAAEAAAICVAEAOw==", i = [].slice,
        j = "emojionearea", k = 0, l = "&#8203;";
    ...
    function E() {
        ...
        if (!b.sprite && b.lasyEmoji[0] && b.lasyEmoji.eq(0).is(".lazy-emoji")) {
            var c = b.picker.offset().top, d = c + b.picker.height() + 20;
            b.lasyEmoji.each(function () {
                var b = a(this), e = b.offset().top;
    ...
    function J(a, b) {
        var c = H(), d = c.split("|"), e = d.indexOf(b);
    ...
    function L(b, c, d) {
        ...
        var g = c.is("TEXTAREA") || c.is("INPUT") ? "val" : "text", i, o, r, t, u, v, z, A, L, M,
        ...
        n(b, z.find(".emojibtn"), {click: "emojibtn.click"}), n(b, window, {resize: "!resize"}), n(b, N.children(), {click: "tone.click"}), n(b, [r, o], {mousedown: "!mousedown"}, i), n(b, o, {click: "button.click"}), n(b, i, {paste: "!paste"}, i), n(b, i, ["focus", "blur"], function () {
        ...
        }), n(b, i, ["mousedown", "mouseup", "click", "keyup", "keydown", "keypress"]), n(b, r.find(".emojionearea-filter"), {click: "filter.click"}), n(b, c, {change: "source.change"}), d.search && n(b, b.search, {
        ...
        if (M.on("scroll", function () {
            ...
            var d = A.filter('[name="' + a.data("filter") + '"]').offset().top, e = M.scrollTop(), f = M.offset().top;
            ...
            var e = function (d) {
                var e = "caret-" + (new Date).getTime(), f = B(d, b);
                q(f), q('<i id="' + e + '"></i>'), c.scrollTop(h);
                var g = a("#" + e), i = g.offset().top - c.offset().top, j = c.height();
            ...
            var g = x(c[0]), h = c.scrollTop(), i = a("<div/>", {contenteditable: !0}).css({
                position: "fixed",
                left: "-999px",
                width: "1px",
                height: "1px",
            ...
            var e = r.find(".emojionearea-filter"), f = d.tones ? N.find("i.active").data("skin") : 0,
            ...
            g && g.length ? (b.recentFilter.hasClass("active") && b.recentFilter.removeClass("active").next().addClass("active"), b.recentCategory.hide(), b.recentFilter.hide(), L.each(function () {
                var b = function (a, b) {
                    ...
                    if (0 === c.length) a.data("tone") === b && a.hide(), e.filter('[data-filter="' + a.attr("name") + '"]').hide(); else {
            ...
            var S = function () {
                ...
                f.sort(), i.textcomplete([{
                    id: j, match: /\B(:[\-+\w]*)$/, search: function (b, c) {
    ...
    function P(b, c) {
        ...
        d[e][c] && (a.each(d[e][c], function (d, e) {
            a.each(a.isArray(e[0]) ? e[0] : [e[0]], function (d, f) {
                a(f).on(e[1], function () {
                    var d = i.call(arguments), f = a.isFunction(e[2]) ? e[2].apply(b, [c].concat(d)) : e[2];
                    f && m(b, c, [f].concat(d))
                })
            })
        }), d[e][c] = null)
    ...
    O.prototype.on = function (b, d) {
        ...
        var a = i.call(arguments), b = [this].concat(a.slice(0, 1));
        ...
        c.each(function () {
            var b = document.querySelector('#input123');
            return b.hasClass("emojionearea-text") || b.addClass("emojionearea-text").html(B(b.is("TEXTAREA") || b.is("INPUT") ? b.val() : b.text(), d)), b
        })
}, window);
