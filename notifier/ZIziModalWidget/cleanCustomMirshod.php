...
<head>
    ...
    <link href="/render/notifier/ZIziModalWidget/assets/custom.css" rel="stylesheet">
...
<div id="modal-custom" data-iziModal-group="grupo1">
    ...
    <section>
        ...
        <input type="password" placeholder="Password">
        <label for="check"><input type="checkbox" name="checkbox" id="check" value="1"> I agree to the
            <u>Terms</u>.</label>
        <footer>
            <button data-iziModal-close>Cancel</button>
