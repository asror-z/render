!function (e, t) {
    ...
    return function (e) {
        ...
        const u = e => document.querySelector(e),
            h = e => "number" == typeof e ? "#" + ("00000" + e.toString(16)).slice(-6) : e, c = (e, t = 1) => {
                const i = h(e), o = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(i),
        ...
        var o = i(0);
        const n = "object" == typeof window, s = n && window.THREE || {};
        n && !window.VANTA && (window.VANTA = {});
        const r = n && window.VANTA || {};
        r.register = (e, t) => r[e] = e => new t(e), r.version = "0.5.3";
        const a = function () {
        ...
        r.VantaBase = class {
            constructor(e = {}) {
                if (!n) return !1;
                if (r.current = this, this.windowMouseMoveWrapper = this.windowMouseMoveWrapper.bind(this), this.windowTouchWrapper = this.windowTouchWrapper.bind(this), this.resize = this.resize.bind(this), this.animationLoop = this.animationLoop.bind(this), this.restart = this.restart.bind(this), this.options = Object(o.c)({}, this.defaultOptions), (e instanceof HTMLElement || "string" == typeof e) && (e = {el: e}), Object(o.c)(this.options, e), this.el = this.options.el, null == this.el) a('Instance needs "el" param!'); else if (!(this.options.el instanceof HTMLElement)) {
                    const e = this.el;
                    if (this.el = Object(o.e)(e), !this.el) return void a("Cannot find element", e)
                }
                let t, i;
                for (t = 0; t < this.el.children.length; t++) i = this.el.children[t], "static" === getComputedStyle(i).position && (i.style.position = "relative"), "auto" === getComputedStyle(i).zIndex && (i.style.zIndex = 1);
                "static" === getComputedStyle(this.el).position && (this.el.style.position = "relative"), this.initThree(), this.setSize();
                try {
                    this.init()
                } catch (e) {
                    return a("Init error", e), this.el.removeChild(this.renderer.domElement), void (this.options.backgroundColor && (console.log("[VANTA] Falling back to backgroundColor"), this.el.style.background = Object(o.a)(this.options.backgroundColor)))
                }
            ...
            windowMouseMoveWrapper(e) {
                const t = this.renderer.domElement.getBoundingClientRect(), i = e.clientX - t.left,
                    o = e.clientY - t.top;
            ...
            windowTouchWrapper(e) {
                if (1 === e.touches.length) {
                    const t = this.renderer.domElement.getBoundingClientRect(), i = e.touches[0].clientX - t.left,
            ...
            setSize() {
                this.scale || (this.scale = 1), Object(o.d)() && this.options.scaleMobile ? this.scale = this.options.scaleMobile : this.options.scale && (this.scale = this.options.scale), this.width = this.el.offsetWidth || window.innerWidth, this.height = this.el.offsetHeight || window.innerHeight
            }
        ...
        class s extends o.b {
            ...
            initBasicShader(e = this.fragmentShader, t = this.vertexShader) {
                ...
                const i = new THREE.ShaderMaterial({uniforms: this.uniforms, vertexShader: t, fragmentShader: e}),
                    o = this.options.texturePath;
                o && (this.uniforms.u_tex = {type: "t", value: (new THREE.TextureLoader).load(o)});
                const n = new THREE.Mesh(new THREE.PlaneGeometry(2, 2), i);
                this.scene.add(n), this.camera = new THREE.Camera, this.camera.position.z = 1
            }
        ...
        t.default = o.a.register("CELLS", n), n.prototype.defaultOptions = {
            color1: 35980,
            color2: 15918901,
