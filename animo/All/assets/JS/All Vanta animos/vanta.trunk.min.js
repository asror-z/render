    ...
    return function (e) {
        ...
        0: function (e, t, i) {
            ...
            const a = e => document.querySelector(e),
                u = e => "number" == typeof e ? "#" + ("00000" + e.toString(16)).slice(-6) : e, c = (e, t = 1) => {
                    const i = u(e), s = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(i),
                        n = s ? {r: parseInt(s[1], 16), g: parseInt(s[2], 16), b: parseInt(s[3], 16)} : null;
            ...
            var s = i(0);
            const n = "object" == typeof window, o = n && window.THREE || {};
            ...
            r.VantaBase = class {
                constructor(e = {}) {
                    if (!n) return !1;
                    if (r.current = this, this.windowMouseMoveWrapper = this.windowMouseMoveWrapper.bind(this), this.windowTouchWrapper = this.windowTouchWrapper.bind(this), this.resize = this.resize.bind(this), this.animationLoop = this.animationLoop.bind(this), this.restart = this.restart.bind(this), this.options = Object(s.c)({}, this.defaultOptions), (e instanceof HTMLElement || "string" == typeof e) && (e = {el: e}), Object(s.c)(this.options, e), this.el = this.options.el, null == this.el) h('Instance needs "el" param!'); else if (!(this.options.el instanceof HTMLElement)) {
                        const e = this.el;
                        if (this.el = Object(s.e)(e), !this.el) return void h("Cannot find element", e)
                    }
                    let t, i;
                    ...
                    try {
                        ...
                        return h("Init error", e), this.el.removeChild(this.renderer.domElement), void (this.options.backgroundColor && (console.log("[VANTA] Falling back to backgroundColor"), this.el.style.background = Object(s.a)(this.options.backgroundColor)))
                    }
                ...
                applyCanvasStyles(e, t = {}) {
                    Object(s.c)(e.style, {
                        ...
                        left: 0,
                        background: ""
                    }), Object(s.c)(e.style, t), e.classList.add("vanta-canvas")
                }
            ...
            class o extends s.b {
                ...
                onInit() {
                    ...
                    this.p5 = new p5(function (t) {
                        let i = Object(n.d)() ? 35 : 55, s = 50, o = 4, r = .2, h = .12, a = 20, u = t.random(1e4),
                            c = t.random(1e4), d = t.random(1e4);

                        function l(e, i, s) {
                            let n = e % t.TWO_PI;
                            return n < 0 && (n += t.TWO_PI), t.noise(u + t.cos(n) * i, c + t.sin(n) * i, d + s)
                        }

                        t.setup = function () {
                            e.initP5(t), t.strokeWeight(1), t.stroke(Object(n.a)(e.options.color)), t.smooth(), t.noFill()
                        }, t.draw = function () {
                            t.clear(), t.translate(t.width / 2, t.height / 2), function () {
                                ...
                                for (let e = 0; e < i; e++) {
                                    t.beginShape();
                                    for (let i = 0; i < 360; i++) {
                                        let n = t.radians(i), u = a * l(n, h * e + r, d) + (o * e + s);
            ...
            class o extends s.b {
                ...
                initP5(e) {
                    ...
                    i.parent(t.el), t.applyCanvasStyles(e.canvas, {background: Object(n.a)(t.options.backgroundColor)}), t.p5renderer = i, t.p5canvas = e.canvas, t.p5 = e
                }
