...
<div class="bloc bloc-head">
    <svg height="300" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 404.7 354"
        ...
        <path data-async="" d="M147.9,40.2L171.2,63.2L175.7,63.2"
              style="stroke-dasharray: 38, 78; stroke-dashoffset: 0;"></path>
        ...
        <path data-async="" d="M265.9,105.2L289.2,129.2L293.7,129.2"
              style="stroke-dasharray: 38, 78; stroke-dashoffset: 0;"></path>
        ...
        <path data-async="" d="M124.2,204.7L124.2,157.2L175.7,157.2"
              style="stroke-dasharray: 99, 139; stroke-dashoffset: 0;"></path>
        ...
        <path data-async="" d="M1.9,40.2L26,63.2L39.7,63.2"
              style="stroke-dasharray: 48, 88; stroke-dashoffset: 0;"></path>
...
<div class="bloc bloc-demo">
    <div class="content">
        ...
        <div>
            <div class="col3">
                <svg id="obturateur1" class="obturateur" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100%"
                     height="200px" viewBox="0 0 200 200" enable-background="new 0 0 200 200"
                     onclick="obt1.reset().play();">
                    ...
                    <path d="M34.042,131.189L67.047,77.781"
                          style="stroke-dasharray: 63, 65; stroke-dashoffset: 0;"></path>
                    <path d="M31.306,75.416L92.41,60.987"
                          style="stroke-dasharray: 63, 65; stroke-dashoffset: 0;"></path>
                    <path d="M68.81,34.042L122.219,67.046"
                          style="stroke-dasharray: 63, 65; stroke-dashoffset: 0;"></path>
                    <path d="M124.584,31.305L139.013,92.409"
                          style="stroke-dasharray: 63, 65; stroke-dashoffset: 0;"></path>
                    <path d="M165.957,68.809L132.953,122.219"
                          style="stroke-dasharray: 63, 65; stroke-dashoffset: 0;"></path>
                    <path d="M168.693,124.584L107.59,139.012"
                          style="stroke-dasharray: 63, 65; stroke-dashoffset: 0;"></path>
                    <path d="M131.19,165.957L77.781,132.953"
                          style="stroke-dasharray: 63, 65; stroke-dashoffset: 0;"></path>
                    <path d="M75.417,168.693L60.987,107.59"
                          style="stroke-dasharray: 63, 65; stroke-dashoffset: 0;"></path>
                </svg>
                <div class="col-container">
                    <h3>Delayed</h3>
                    <p>Every path element is drawn at the same time with a small delay at the start. This is currently
            ...
            <div class="col3">
                ...
                <div class="col-container">
                    <h3>Sync</h3>
                    <p>Each line is drawn synchronously. They all start and finish at the same time, hence the name
                        `sync`.</p>
                    <button onclick="obt2.reset().play();">replay</button>
                </div>
            </div>
            <div class="col3">
                <svg id="obturateur3" class="obturateur" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100%"
                     height="200px" viewBox="0 0 200 200" enable-background="new 0 0 200 200"
                     onclick="obt3.reset().play();">
                    <path d="M10,100A90,90 0,1,1 190,100A90,90 0,1,1 10,100"
                          style="stroke-dasharray: 566, 568; stroke-dashoffset: 0;"></path>
                    <path d="M14.260000000000005,100A85.74,85.74 0,1,1 185.74,100A85.74,85.74 0,1,1 14.260000000000005,100"
                          style="stroke-dasharray: 539, 541; stroke-dashoffset: 0;"></path>
                ...
                <div class="col-container">
                    <h3>OneByOne</h3>
                    <p>Each path element is drawn one after the other. This animation gives the best impression of live
                        drawing.</p>
...
<div class="bloc bloc-timing">
    <div class="content">
        <div>
            <svg id="timing-example" version="1.1" xmlns="http://www.w3.org/2000/svg"
                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 200 200"
                 enable-background="new 0 0 200 200" xml:space="preserve"
                 onclick="timing&amp;&amp;timing.reset().play();">
            ...
            <div class="timing-title">
                <p>Type
                    <span class="button-group">
								<button onclick="timingTest(this,&#39;type&#39;,&#39;delayed&#39;);"
                                        class="active"><span>delayed</span></button>
                ...
                <p>Path timing function
                    <span class="button-group">
								<button onclick="timingTest(this,&#39;path&#39;,&#39;LINEAR&#39;);"
                                        class="active"><span>linear</span></button>
                ...
                <p>Anim timing function
                    <span class="button-group">
								<button onclick="timingTest(this,&#39;anim&#39;,&#39;LINEAR&#39;);"
                                        class="active"><span>linear</span></button>
...
<div class="bloc bloc-scenario">
    <div class="content">
        ...
        <div class="script-example">
            <svg id="polaroid" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 200 160"
                 enable-background="new 0 0 200 160" onclick="pola.reset().play();">
                ...
                <path data-async="" data-duration="40" d="
                      ...
                      style="stroke-dasharray: 379, 381; stroke-dashoffset: 0;"></path>
                <path data-async="" data-duration="40" d="
                      ...
                      style="stroke-dasharray: 228, 230; stroke-dashoffset: 0;"></path>
                <path data-async="" data-duration="40" d="M103.377,128.225L154.768,155.32"
                      style="stroke-dasharray: 59, 61; stroke-dashoffset: 0;"></path>
                <path data-async="" data-duration="40" d="M109.852,112.684L155.035,136.906"
                      style="stroke-dasharray: 52, 54; stroke-dashoffset: 0;"></path>
                <path data-async="" data-duration="40" d="
                      ...
                      style="stroke-dasharray: 298, 300; stroke-dashoffset: 0;"></path>
                <path data-async="" data-duration="40" d="
                ...
                <path data-delay="20" d="
                      ...
                      style="stroke-dasharray: 154, 156; stroke-dashoffset: 0;"></path>
                <path d="
                ...
                <path d="
                      ...
                      style="stroke-dasharray: 33, 35; stroke-dashoffset: 0;"></path>
                ...
                <path d="
                      ...
                      style="stroke-dasharray: 60, 62; stroke-dashoffset: 0;"></path>
                ...
                <path d="
                      ...
                      style="stroke-dasharray: 177, 179; stroke-dashoffset: 0;"></path>

                <!-- Design (color lines on the front) -->
                <!-- All the lines will start at the same time, because they all have the attribute `data-async` -->
                <path data-async="" d="M47.583,101.505L51.561,88.267"
                      style="stroke-dasharray: 14, 16; stroke-dashoffset: 0;"></path>
                <path data-async="" d="M53.391,102.326L57.047,90.125"
                      style="stroke-dasharray: 13, 15; stroke-dashoffset: 0;"></path>
                <path data-async="" d="M59.224,103.068L62.749,91.295"
                      style="stroke-dasharray: 13, 15; stroke-dashoffset: 0;"></path>
                <path data-async="" d="M65.057,103.814L69.015,90.637"
                      style="stroke-dasharray: 14, 16; stroke-dashoffset: 0;"></path>
                <path data-async="" d="M72.87,19.969L75.497,11.082"
                      style="stroke-dasharray: 10, 12; stroke-dashoffset: 0;"></path>
                <path data-async="" d="M78.512,21.325L81.317,11.868"
                      style="stroke-dasharray: 10, 12; stroke-dashoffset: 0;"></path>
                <path data-async="" d="M83.833,23.718L87.16,12.582"
                      style="stroke-dasharray: 12, 14; stroke-dashoffset: 0;"></path>
                <path data-async="" d="M89.145,26.141L92.939,13.498"
                      style="stroke-dasharray: 14, 16; stroke-dashoffset: 0;"></path>
...
<!-- Le scripts -->
<script src="https://cdn.jsdelivr.net/npm/vivus@0.4.5/dist/vivus.js"></script>


<!--START VIVUS JS OPTION LIST-->
