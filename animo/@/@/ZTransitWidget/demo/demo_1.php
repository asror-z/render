...
define('Yarner', Cdn . '/publish/yarner');
define('Bower', Cdn . '/publish/bower');
define('Publish', Cdn . '/publish');
?>
<html lang="en"
...
<div class="section top">
    <div class="nav l-page">
        ...
        <ul class="left aux">
            ...
            <li>
                <a href="<?= Yarner ?>/jquery.transit.min.js">Download</a>
            </li>
            <li>
    ...
    <div class="card title l-page">
        ...
        <div class="download">
            <a href="<?= Yarner ?>/jquery.transit.min.js">
<span class="in">
<span class="inin">
...
<small>Download</small>
        ...
        <div class="main-notes">
            ...
            <p>
                ...
                You may also download the <a href="<?= Yarner ?>/jquery.transit.js">development
...
<i><i>
        ...
        <div class="gap dark">
            <a href="<?= Yarner ?>/jquery.transit/#top" class="thing"></a>
        </div>
