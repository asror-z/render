...
<script type="text/javascript">
    ...
    var editor = grapesjs.init({
        ...
        canvas: {
             ...
             */
            styles: [
                '/vendor/kartik-v/yii2-widget-select2/src/assets/css/select2-krajee-bs4.min.css',
                '/vendor/kartik-v/yii2-widget-select2/src/assets/css/select2-addl.min.css',
                '/vendor/kartik-v/yii2-widget-select2/src/assets/css/select2-bootstrap.min.css',
    ...
    editor.on('component:mount', function (e) {       //added
...
//       e.set('content', '1111111111');
    ...
    editor.on('component:create', function (e) {
    ...
    editor.on('block:add', function (e) {           //added
    ...
    /**
     *
     * https://grapesjs.com/docs/api/editor.html#assets
     */
    editor.on('assets:add', function (e) {
     ...
     * https://grapesjs.com/docs/api/editor.html#assets
     */
    editor.on('assets:remove', function (e) {
     ...
     * https://grapesjs.com/docs/api/editor.html#assets
     */
    editor.on('assets:start', function (e) {
     ...
     * https://grapesjs.com/docs/api/editor.html#assets
     */
    editor.on('assets:end', function (e) {
     ...
     * https://grapesjs.com/docs/api/editor.html#assets
     */
    editor.on('assets:response', function (e) {
     ...
     * https://grapesjs.com/docs/api/editor.html#assets
     */
    editor.on('assets:error', function (e) {
    ...
    editor.on('keymap:add', function (e) {
    ...
    editor.on('keymap:remove', function (e) {
    ...
    editor.on('keymap:emit', function (e) {
    ...
    editor.on('  emit:(id, alt + u, e)', function (e) {
    ...
    editor.on('styleManager:update:target', function (e) {
    ...
    editor.on('styleManager:change', function (e) {
    ...
    editor.on('styleManager:change:{propertyName}', function (e) {
    ...
    editor.on('storage:start:store', function (e) {
    ...
    editor.on('canvas:dragenter', function (e) {
    ...
    editor.on('canvas:dragover', function (e) {
    ...
    editor.on('canvas:dragend', function (e) {
    ...
    editor.on('canvas:dragdata', function (e) {
    ...
    editor.on('selector:add', function (e) {
    ...
    editor.on('rte:disable', function (e) {
    ...
    editor.on('modal:open', function (e) {
    ...
    editor.on('modal:close', function (e) {
    ...
    editor.on('run:{commandName}', function (e) {
    ...
    editor.on('stop:{commandName}', function (e) {
    ...
    editor.on('run:{commandName}:before', function (e) {
    ...
    editor.on('stop:{commandName}:before', function (e) {
    ...
    editor.on('abort:{commandName}', function (e) {
    ...
    /**
     *
     *  https://grapesjs.com/docs/api/editor.html#general
     */


    editor.on('canvasScroll', function (e) {
...
<div class="help-block invalid-feedback"></div>
    ...
    blockManager.add('accardion-block11', {
        ...
        content: {
            content:`<link rel="stylesheet" href="/render/Former/Icheck/css/ablmolodoy.css"/>
