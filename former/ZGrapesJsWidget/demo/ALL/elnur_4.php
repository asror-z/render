...
use zetsoft\widgets\inputes\ZButton2Widget;
...
<head>
    ...
    <link rel="stylesheet" href="/publish/yarner/mdbootstrap/css/bootstrap.min.css">
    ...
    <script src="/publish/yarner/grapesjs-plugin-forms-ca/dist/grapesjs-plugin-forms.min.js"></script>
...
<button id="compBtns" class="btn btn-success" type="submit">Load</button>
<!--<button id="compBtns2" class="btn btn-success" type="submit">Load2</button>-->

<div class="grDivClass" style="display: none;position: absolute;z-index: ">

    <input type="text" id="grInput" class="form-control">
...
<script>
   ...
   /* $('.gjs-comp-selected').click(function () {
...
<script>
    ...
    editor.on('component:selected', function (e) {
        ...
        clickTrigger('/testing/Former/Grapes/forms.php?id='+e.ccid);


           $("#grButton").click(function () {

        var grElId =$("#myID").value;
        var val=$("#grInput").value;
    ...
    // $("#compBtns").click(function (event) {
    //     var ud = editor.getComponents();
    //     var byId=ud['_byId'];
    //     $.each(byId, function(index, value) {
    //     var attr=byId['attributes'];
...
/*
 ...
 $("#compBtns2").click(function (event) {
     var ud = editor.getComponents();
         console.log(e);
    });
*/
...
// else
//         var ud = editor.getComponents();
//             $.each(ud['_byId'], function(index, value) {
...
function clickTrigger(url) {
    ...
    $.ajax({
        ...
        /*
         ...
         accepts: {
           mytype: 'application/x-some-custom-type'
         },
         contents : {
             mycustomtype: /mycustomtype/
         },
         converters: {
              /!*converterFromCustomTypeTomytype*!/
           'mycustomtype mytype': function(result) {
              /!*  Do Stuff

             return newresult;*!/
           },

               /!* converterFromCustomTypeToJson *!/
           'mycustomtype array' : function(result) {
              /!*  Do Stuff
