...
<head>
    ...
    <link rel="stylesheet" href="/render/former/ZGrapesJsWidget/clean/ALL/dist/css/grapes.min.css">
    <link rel="stylesheet" href="/render/former/ZGrapesJsWidget/clean/ALL/dist/grapesjs-preset-webpage.min.css">
    <!--<link rel="stylesheet" href="/render/former/ZGrapesJsWidget/assets/grapesjs/dist/css/grapes.css">-->
    ...
    <script src="/render/former/ZGrapesJsWidget/clean/ALL/dist/grapes.min.js"></script>

    <script src="/render/former/ZGrapesJsWidget/clean/ALL/dist/grapesjs-preset-webpage.min.js"></script>
    ...
    <script type="text/javascript" src="../../../../ALL/ruler/RulersGuides.js"></script>
    ...
    <style>
        ...
        .gjs-pn-panel:nth-child(3) .gjs-pn-buttons, .gjs-pn-panel:nth-child(3) .gjs-pn-buttons span{
        ...
        .gjs-pn-options.gjs-pn-buttons span{
            padding:0 5px!important;

        }

        .gjs-pn-devices-c .gjs-pn-buttons span{
        ...
        .gjs-pn-panel:nth-child(3),.gjs-pn-panel:nth-child(3) .gjs-pn-buttons{
            padding:0;
        }
...
<body>
    ...
    <script type="text/javascript">
        ...
        blockManager.add('select-block', {
            ...
            content: {
                content: `
            <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/css/select2.css">
            <select class="select2" style="width:100%"><option>asdsadsa</option><option>sadasda</option></select>`,

                script:function () {
                    $(document).ready(function () {
                        $(".select2").select2({
                            width: 'resolve',
                            placeholder: 'rowan kot yidi ot yemasayam kot'
                        });
                    })
                },
            },
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            div1.className = "container horizontal";
            div2.className = "container vertical";
            xx.append(div1);
            xx.append(div2);
    ...
    <style>
        ...
        .horizontal {
            ...
            background-size: 100px 100%, 10px 50%;
        }
        ...
        .vertical {
            ...
            background-image: repeating-linear-gradient(180deg, black 1px, transparent 2px, transparent 100px),
            repeating-linear-gradient(180deg, red 1px, transparent 2px, transparent 10px);
            background-position: 0 4%; /* vertical offset to clear horizontal background */
