    ...
    var editor = grapesjs.init({
        ...
        canvas: {
            ...
            styles: [
                ...
                '/publish/theme/mdbpro/css/mdb.min.css'
...
//       e.set('content', '1111111111');
    ...
    blockManager.add('some-block-id', {
        label: `<div><img src="https://picsum.photos/70/70"/> <div class="my-label-block">Widgets zetsoft</div></div>`,
        content: '<div></div>',
        category: 'zetsoft',
     ...
     const blockManager2 = editor.BlockManager;

    blockManager2.add('some-new-id', {
    label: `<div><img src="https://picsum.photos/70/70"/> <div class="my-label-block">Widgets</div></div>`,
    content: '\n' +
        '<form id="w0" class="form-horizontal kv-form-horizontal kv-form-bs4" action="#" method="post" enctype="multipart/form-data" data-pjax="1">\n' +
        '    <input type="hidden" name="_csrf" value="s3CXTIc0GVURu11GWI3N-lhOHDZVbqi1IatC0Mdk_cDDBvx6zk5IJV38PhFq94iebQRabxI67v1ukgSYjQuaig=="><div style="text-align: right; margin: 10px"><button type="submit" id="submitButton" class="btn btn-primary">Сохранить</button></div>\n' +
        '\n' +
        '    <div class="highlight-addon row field-coreinput-zhcheckboxbuttongroupwidget">\n' +
        '\n' +
        '        <div class="col-md-12">\n' +
        '            <input type="hidden" name="CoreInput[zhcheckboxbuttongroupwidget]" value=""><div id="coreinput-zhcheckboxbuttongroupwidget" class="btn-group btn-group-toggle" role="group" options="{&quot;id&quot;:&quot;coreinput-zhcheckboxbuttongroupwidget&quot;}" data-toggle="buttons" inline=""><label class="btn btn-secondary"><input type="checkbox" name="CoreInput[zhcheckboxbuttongroupwidget][]" value="1"> 111111111</label>\n' +
        '            <label class="btn btn-secondary"><input type="checkbox" name="CoreInput[zhcheckboxbuttongroupwidget][]" value="2"> 222222222</label>\n' +
        '            <label class="btn btn-secondary"><input type="checkbox" name="CoreInput[zhcheckboxbuttongroupwidget][]" value="3"> 333333333</label>\n' +
        '            <label class="btn btn-secondary"><input type="checkbox" name="CoreInput[zhcheckboxbuttongroupwidget][]" value="4"> 444444444</label>\n' +
        '            <label class="btn btn-secondary"><input type="checkbox" name="CoreInput[zhcheckboxbuttongroupwidget][]" value="5"> 555555555</label>\n' +
        '            <label class="btn btn-secondary"><input type="checkbox" name="CoreInput[zhcheckboxbuttongroupwidget][]" value="6"> 666666666</label></div>\n' +
        '\n' +
