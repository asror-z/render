...
$page2 = file_get_contents('../../../Animos/Background/CSSJS 3D/Wagerfield Parallax/clean1.html');
?>
  ...
  /*
   ...
   /* editor.on('block:drag:stop', function (e) {
    ...
    blockManager.add('some-block-id', {
        ...
        content: {
            id:'#one',
            type: 'text', // Built-in 'map' component
    ...
    blockManager.add('select-block', {
        ...
        content: {
            content: `<select class="js-example-responsive" multiple="multiple" style="width: 100%"></select>`

            script:$(".js-example-responsive").select2({
