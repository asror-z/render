...
<script type="text/javascript">
    ...
    editor.on('component:add', function (event) {
        ...
        console.log(event.ccid);
        $("#" + e.ccid).
    });

    
    /*editor.on('storage:load', function (event) { console.log('Loaded ', e)
     });
    editor.on('storage:store', function (event) { console.log('Stored ', e) });
    ...
    editor.on('component:update:{propertyName}', function (event) {
    ...
    // Assets
    editor.on('asset:add', function (event) {
        console.log('ZGrapesJs | asset:add');
        console.log(event.get('type'));
        /!*console.log(e);*!/
    });
    editor.on('asset:remove', function (event) {
        console.log('ZGrapesJs | asset:remove');
        console.log(event.get('type'));
        /!*console.log(e);*!/
    });
    editor.on('asset:upload:start', function (event) {
        console.log('ZGrapesJs | asset:upload:start');
        console.log(event.get('type'));

        /!*console.log(e);*!/
    });
    editor.on('asset:upload:end', function (event) {
        console.log('ZGrapesJs | asset:upload:end');
        console.log(event.get('type'));
       /!* console.log(e);*!/
    });
    editor.on('asset:upload:error', function (event) {
        console.log('ZGrapesJs | asset:upload:error');
        console.log(event.get('type'));
        /!*console.log(e);*!/
    });
    editor.on('asset:upload:response', function (event) {
        console.log('ZGrapesJs | asset:upload:response');
        console.log(event.get('type'));
        /!*console.log(e);*!/
    });
    // keymaps
    ...
    editor.on('keymap:emit:{keymapId}', function (event) {
        console.log('ZGrapesJs | keymap:emit:{keymapId}');
        console.log(event.get('type'));
        console.log('keymap:emit:{keymapId}')
        /!*console.log(e);*!/
    });
    // Style Manager
    ...
    editor.on('storage:error:store', function(objectToStore) {
