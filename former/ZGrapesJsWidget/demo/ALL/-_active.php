...
<body>
    ...
    <script type="text/javascript">
        var editor = grapesjs.init({
            ...
            canvas: {
                ...
                styles: [
                    ...
                    '/publish/inputs/grapJsMusoxon/assets/fileinput.css',

                ],


                scripts: [
                    '/publish/yarner/jquery/dist/jquery.min.js',
                    ...
                    '/publish/yarner/bootstrap/dist/js/bootstrap.min.js',
                    '/publish/yarner/piexifjs/piexif.js',
                    '/publish/yarner/sortablejs/Sortable.js',
                    '/publish/yarner/purify/src/purify.js',
                    '/publish/inputs/grapJsMusoxon/assets/fileinput.js',
                    '/publish/yarner/bootstrap/dist/js/bootstrap.bundle.js',
                    '/publish/yarner/bootstrap-fileinput/themes/explorer-fas/theme.js',
        ...
        blockManager.add('bootstrapInput-block11', {
            ...
            content: {
                content: `<link rel="stylesheet" href="/publish/yarner/bootstrap/dist/css/bootstrap.min.css">
            <link href="/publish/yarner/bootstrap-fileinput/css/fileinput.css" media="all" rel="stylesheet" type="text/css"/>
            <link rel="stylesheet" href="/publish/yarner/@fortawesome/fontawesome-free/css/all.min.css">
            <link href="/publish/yarner/bootstrap-fileinput/themes/explorer-fas/theme.css" rel="stylesheet" type="text/css">
