...
use zetsoft\widgets\display\ZMapGlobeWidget;
use zetsoft\widgets\inputes\ZTinyMce5Widget;

$page = file_get_contents('../../../Places/Maps/leaflet/leaflet.html');
$page2 = file_get_contents('../../../../widgets/blocks/ZMapGlobeWidget.php');
$page3 = file_get_contents('../../../GrapesSave/outGrapesSave.html');
...
<script>
    ...
    $(document).ready(function () {
        $('button').click(function () {
            var pcontent=$("iframe")[0].contentWindow.document.documentElement.outerHTML;
            $.ajax({
                url: '../../../GrapesSave/save.php',
                type: "POST",
    ...
    var editor = grapesjs.init({
        ...
        canvas: {
            ...
            scripts: [
                ...
                '/publish/Maps/Rotating Globe/assets/core.js',
                '/publish/Maps/Rotating Globe/assets/maps.js',
                '/publish/Maps/Amcharts/amcharts4/themes/frozen.js',
                '/publish/Maps/Rotating Globe/assets/animated.js',
                '/publish/Maps/Rotating Globe/assets/worldLow.js',
                '/publish/Maps/Rotating Globe/assets/continentsLow.js',
  ...
  */
  ...
  /*
   ...
   /* editor.on('block:drag:stop', function (e) {
    ...
    /* editor.on('  emit:{keymapId}', function (e) {
         console.log('ZGrapesJs |   emit:{keymapId}');
         /!*console.log(e);*!/
     });*/
    ...
    blockManager.add('some-block-id1', {
        category: 'zetsoft',
        label: `<div><img src="https://picsum.photos/70/70"/> <div class="my-label-block">TinyCloud</div></div>`,
        content: {
                    type: 'map',
                    removable: true,
                    draggable: true,
                    ...
                    attributes:{
                        ...
                        id: 'TinyCloud',
                        class: 'fas fa-car',
                        src: `../../../Inputs/Wysiwig/CSSJS/tinymce5/clean.html`,
    ...
    blockManager.add('some-block-id2', {
        category: 'zetsoft',
        label: `<div><img src="https://picsum.photos/80/80"/> <div class="my-label-block">Yandex Map</div></div>`,
        content: {
            type: 'map',
            removable: true,
            draggable: true,
            ...
            attributes:{
                ...
                id: 'YandexMap',
                class: 'fas fa-car',
                src: `../../../Places/Maps/yandex/map5_objectManager.html`,
    ...
    blockManager.add('some-block-id3', {
        category: 'zetsoft',
        label: `<div><img src="https://picsum.photos/70/70"/> <div class="my-label-block">Google Map</div></div>`,
        content: {
            type: 'map',
            tagName: 'div',
            removable: true,
            ...
            attributes:{
                ...
                id: 'GoogleMap',
                class: 'fas fa-car',
                src: `../../../Places/Maps/google/map8_routes.html`,
    ...
    blockManager.add('some-block-id4', {
        category: 'zetsoft',
        label: `<div><img src="https://picsum.photos/70/70"/> <div class="my-label-block">Glob Map</div></div>`,
        content: {
            type: 'map',
            tagName: 'div',
            removable: true,
            ...
            attributes:{
                ...
                id: 'GlobMap',
                class: 'fas fa-car',
                src: `../../../Places/Map1/cleanofGlob.html`,
