...
!function (e, t) {
    ...
    return function (e) {
        ...
        var a = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r = e.DomComponents,
                n = Object.keys, o = {
                    strings: [],
                    'type-speed': 0,
                    'start-delay': 0,
            ...
            a.unshift({changeProp: 1, name: 'strings', type: "typed-strings"}), r.addType("typed", {
                model: {
                    defaults: t.props(s({}, o, {
                        typedsrc: t.script, droppable: 0, traits: a, script: function () {
                            var e = this, t = JSON.parse('{[ strings ]}'), r = function (e) {
                                ...
                                var c = parseInt('{[ loop-count ]}', 10), s = {
                        ...
                        var e = this, t = a.filter((function (e) {
        ...
        var u = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r = e.BlockManager,
                n = t.block;
            n && r.add("typed", p({
                label: 'Typed',
        ...
        t.default = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r = d({}, {
                script: 'https://cdn.jsdelivr.net/npm/typed.js@2.0.11', block: {}, props: function (e) {
                    return e
                }
            }, {}, t);
            a(e, r), u(e, r), f(e)
