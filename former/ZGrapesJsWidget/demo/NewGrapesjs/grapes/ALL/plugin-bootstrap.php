...
<head>
    ...
    use zetsoft\assets\grapes\ZGrapeBootstrapAsset;

    ZGrapeBootstrapAsset::register($this);
    ?>
        ...
        pluginsOpts: {
            'grapesjs-blocks-bootstrap4': {
                ...
                labels: {
                    ...
                    other:{
                        gridDevices:true,
                        gridgridDevicesPanel:false,
                        gridformPredefinedActions:null,
                        gridoptionstringSeparator:"",
                    }
