...
use zetsoft\widgets\former\ZGrapesJsWidgetFeruza;
...
\zetsoft\widgets\former\ZGrapesJsWidgetMalikaFeruza::begin([
    'config' => [
        'scripts' => $scripts,
        'styles' => $links,
        'categories' => [
...
\zetsoft\widgets\former\ZGrapesJsWidgetMalikaFeruza::end();
