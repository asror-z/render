...
use zetsoft\widgets\former\ZGrapesJsWidgetEXU;
...
ZGrapesJsWidgetEXU::begin([
      ...
      $(editor.Canvas.getDocument().body).click((evt) => {
         $(evt.target).parent()[0].offsetParent.previousElementSibling
         console.log('$(this)');
         console.log($($($(evt.target).parents('#itiw')).find('[data-widget]')).attr('data-widget'));
         console.log('$(this)');
    });
...
JS,
   ...
   function component_selected(e) {
            ...
            if (splitedClassName.includes('zetsoft')) {
                ajaxGrapes('/core/widget/option.aspx?className=' + className);
            }
