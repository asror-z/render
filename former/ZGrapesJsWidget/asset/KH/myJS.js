...
$('.desktop').on('click', function () {
    $('.desktop').addClass('gjs-pn-active');
    $('.tablet').removeClass('gjs-pn-active');
    $('.mobile').removeClass('gjs-pn-active');
    $('.gjs-frame').width('100%');
});

$('.tablet').on('click', function () {
    $('.tablet').addClass('gjs-pn-active');
    $('.desktop').removeClass('gjs-pn-active');
    $('.mobile').removeClass('gjs-pn-active');
