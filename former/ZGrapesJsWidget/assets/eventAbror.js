...
function loadEditor() {
    ...
    const panelButtons = "<div class='panelButtons'> <div class='firstBtn w-100'><i class='fal fa-eye panelIcons'></i><br><p class='buttonTitles'>Предосмотр</p></div> <div class='secondBtn w-100'><i class='fal fa-save panelIcons'></i><br><p class='buttonTitles'>Сохранить</p></div> <div class='ComponentBtn w-100'><i class='fad fa-th-large panelIcons'></i><br><p class='buttonTitles'>Компоненты</p></div> <div class='UrlBtn w-100'><i class='fal fa-external-link panelIcons'></i><br><p class='buttonTitles'>Перейти</p></div> </div>";

    $('.gjs-pn-views').append(panelButtons);
