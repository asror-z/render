...
function componentSelected(model) {
    ...
    $(divs).addClass('btn-floating btn-sm btn-primary ml-auto params component-options')

    let deleteDiv = document.createElement('a')
    $(deleteDiv).addClass('btn-floating btn-sm btn-primary delete delete-option')

    let copyDiv = document.createElement('a')
    $(copyDiv).addClass('btn-floating btn-sm btn-primary copy copy-option')

    let addContents = document.createElement('a')
    $(addContents).addClass('btn-floating btn-sm btn-primary adding adding-option')
    ...
    $(divs).animate({ opacity: 0 }, 1000)
    $(deleteDiv).animate({ opacity: 0 }, 1000)
    $(copyDiv).animate({ opacity: 0 }, 1000)
    $(addContents).animate({ opacity: 0 }, 1000)
