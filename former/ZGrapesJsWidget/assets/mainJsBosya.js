    ...
    commands: {
        defaults: [
                ...
                run() {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            //newEl.attr('data-css', cssText);
                            newEl.attr('css', cssText);
                            newEl.html(response);
            ...
            },
            {
                ...
                run() {
                    Swal.fire({
                            title: 'Помощь для вас!',
                        text: 'GrapesJS Webpage Builder - это простая демонстрация того, чего можно достичь с помощью базовой библиотеки GrapesJS. Чтобы получить любой намек по поводу демонстрации, проверьте репозиторий предустановок веб-страницы и откройте вопрос. В случае проблем с самим сборщиком, откройте проблему в основном репозитории GrapesJS. Мы приветствуем участие и поддержку бесплатного проекта с открытым исходным кодом. Если вам нравится проект, поддержите его пожертвованием по вашему выбору или станьте спонсором через Open Collective',
                    });
                },
            },
            {id: 'clear'},
