            ...
            },
            {
                ...
                run() {
                    ...
                    Swal.fire({
                        ...
                        html: `<iframe id="grapesBlockFrame" src="{blockPath}" height="400px" width="100%" class="border-0" scrolling="no"></iframe>`,
                        onOpen: function () {
                            var iframe = document.getElementById('grapesBlockFrame');

                            $(iframe).on('load', function () {
                            
                                var form = iframe.contentWindow.document.getElementById('grapesBlockForm');

                                $(form).on('submit', function () {
                                    var serialize = $(form).serialize()
                                    saveContentBlock('ajax', serialize)
                                })
                            })
                        }
                    })
