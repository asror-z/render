...
<script src="/render/former/ZVvvebJsWidget/assets/libs/builder/builder.js"></script>
<script src="/render/former/ZVvvebJsWidget/assets/libs/builder/undo.js"></script>
<script src="/render/former/ZVvvebJsWidget/assets/libs/builder/inputs.js"></script>
<script src="/render/former/ZVvvebJsWidget/assets/libs/builder/components-widgets.js"></script>
<script src="/render/former/ZVvvebJsWidget/assets/libs/builder/components-bootstrap4.js"></script>
<link rel="stylesheet" href="/render/former/ZVvvebJsWidget/assets/libs/codemirror/lib/codemirror.css">
<link rel="stylesheet" href="/render/former/ZVvvebJsWidget/assets/libs/codemirror/theme/material.css">
<link rel="stylesheet" href="/render/former/ZVvvebJsWidget/assets/css/editor.css">
<link rel="stylesheet" href="/render/former/ZVvvebJsWidget/assets/css/line-awesome.min.css">
<script src="/render/former/ZVvvebJsWidget/assets/libs/codemirror/lib/codemirror.js"></script>
<script src="/render/former/ZVvvebJsWidget/assets/libs/codemirror/lib/xml.js"></script>
<script src="/render/former/ZVvvebJsWidget/assets/libs/codemirror/lib/formatting.js"></script>
<script src="/render/former/ZVvvebJsWidget/assets/libs/builder/plugin-codemirror.js"></script>
<script src="/render/former/ZVvvebJsWidget/assets/libs/builder/blocks-bootstrap4.js"></script>
...
<div id="vvveb-builder">
  ...
  <div id="right-panel">
    <div class="component-properties">
      ...
      <ul class="nav nav-tabs nav-fill" id="properties-tabs" role="tablist">
        <li class="nav-item content-tab">
          <a class="nav-link active" data-toggle="tab" href="#content-tab" role="tab" aria-controls="components"
             aria-selected="true">
            <i class="la la-lg la-cube"></i>
            <div><span>Content</span></div>
          </a>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary btn-lg" data-dismiss="modal"><i class="la la-close"></i> Close
          </button>
        </div>
      </div>
    </div>
  ...
  Vvveb.FileManager.addPages(
    [
      ...
      },
      {
        name: 'landing-page',
        title: 'Landing page',
        url: 'demo/startbootstrap-landing-page/index.html',
        file: 'demo/startbootstrap-landing-page/index.html',
        assets: ['demo/startbootstrap-landing-page/css/landing-page.min.css'],
      },
      {
        name: 'album',
        title: 'Album',
      ...
      },
      {
        ...
        folder: 'content',
        assets: ['demo/offcanvas/offcanvas.css', 'demo/offcanvas/offcanvas.js'],
      },
      {
        name: 'pricing',
        title: 'Pricing',
