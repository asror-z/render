...
function MenuEditor(idSelector, options) {
    ...
    $(document).on('click', '.btnEdit', function(e) {
        ...
        $('#SelectOption').val(class_arr).trigger("change");
        $('#RoleValue').val(role_arr).trigger("change");
        $('#targetValue').val(target).trigger("change");
    });
    ...
    this.update = function() {
        ...
        var target_val = $('#targetValue').val();
