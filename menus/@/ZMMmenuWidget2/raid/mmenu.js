!function (e) {
    ...
    var u = {Menu: "منو"}, h = {Menu: "Menü"}, v = {Menu: "Меню"};
        ...
        return e.prototype.openPanel = function (e, t) {
            ...
            if (this.trigger("openPanel:before", [e]), e && (e.matches(".mm-panel") || (e = e.closest(".mm-panel")), e)) {
                if ("boolean" != typeof t && (t = !0), e.parentElement.matches(".mm-listitem_vertical")) {
                    ...
                    var a = _(this.node.pnls, ".mm-panel"), s = _(this.node.pnls, ".mm-panel_opened")[0];
                    a.filter(function (t) {
                        return t !== e
                    }).forEach(function (e) {
    ...
    var G = "ontouchstart" in window || !!navigator.msMaxTouchPoints || !1, K = {top: 0, right: 0, bottom: 0, left: 0},
        ...
        }(), ae = null, se = null, oe = 0, re = function (e, t, n) {
    ...
    S.options.drag = Z;
    var ce = {drop: !1, fitViewport: !0, event: "click", position: {}, tip: !0};
    ...
    S.configs.fixedElements = me, S.configs.classNames.fixedElements = {fixed: "Fixed"};
    var de = {use: !1, top: [], bottom: [], position: "left", type: "default"};
    S.options.iconbar = de;
    var pe = {add: !1, blockPanel: !0, hideDivider: !1, hideNavbar: !0, visible: 3};
    ...
    function ge() {
        ...
        if (void 0 !== t) {
            ...
            t.length && (t.forEach(function (t) {
                ...
                var i = b("div.mm-navbar"), a = t.position;
                "bottom" !== a && (a = "top"), n[a] || (n[a] = b("div.mm-navbars_" + a)), n[a].append(i);
                for (var s = 0, o = t.content.length; s < o; s++) {
                    var r, c = t.content[s];
                    if ("string" == typeof c) if ("function" == typeof (r = ge.navbarContents[c])) r.call(e, i); else {
                        var l = b("span");
                        l.innerHTML = c;
                        var m = _(l);
    ...
    S.options.navbars = ve, S.configs.navbars = be, S.configs.classNames.navbars = {
        ...
        breadcrumbs: function (e) {
            ...
            var t, n, i, a = this, s = b("a.mm-btn.mm-btn_next.mm-navbar__btn");
            ...
            var t, n, i, a = this, s = b("a.mm-btn.mm-btn_prev.mm-navbar__btn");
            ...
            var t, n, i, a, s = this, o = b("a.mm-navbar__title");
    ...
    var we = {clear: !1, form: !1, input: !1, submit: !1},
        Ee = {Search: "جستجو", "No results found.": "نتیجه‌ای یافت نشد.", cancel: "انصراف"},
        xe = {Search: "Suche", "No results found.": "Keine Ergebnisse gefunden.", cancel: "beenden"},
    ...
    var Pe = function () {
        ...
        var a, s = b((n.form ? "form" : "div") + ".mm-searchfield"), o = b("div.mm-searchfield__input"), r = b("input");
        ...
        var a = _(this.node.pnls, ".mm-panel_search")[0], s = g(e, "input")[0], o = g(e, ".mm-searchfield__cancel")[0];
    ...
    S.prototype.search = function (e, t) {
        var n, i = this, a = this.opts.searchfield;
        this.conf.searchfield;
        t = (t = t || "" + e.value).toLowerCase().trim();
        var s = e.mmSearchfield, o = g(e.closest(".mm-searchfield"), ".mm-btn"),
            r = _(this.node.pnls, ".mm-panel_search")[0], c = s.panels, l = s.noresults, m = s.listitems,
            d = s.dividers;
        if (m.forEach(function (e) {
            ...
            d.forEach(function (e) {
                ...
                var n, i = _(e, ".mm-listitem__text")[0], s = !1;
 ...
 */
        ...
        offcanvas: function () {
            ...
            if (this.opts.autoHeight = s(t, S.options.autoHeight), "auto" == t.height || "highest" == t.height) {
                var n, i = (n = function (e) {
                    ...
                    if (!e.opts.offCanvas || e.vars.opened) {
                        var i, a, s = 0, o = e.node.menu.offsetHeight - e.node.pnls.offsetHeight;
            ...
            if (this.opts.offCanvas) {
                ...
                this.opts.drag = s(t, S.options.drag), t.open && this.bind("setPage:after", function (n) {
                    (function (e) {
                        ...
                        se && (N(se, "dragStart"), N(se, "dragMove"), N(se, "dragEnd")), ae = new ie(se = e), a(), a = function () {
                        }, se && (C(se, "dragStart", function (e) {
            ...
            if (this.opts.offCanvas) {
                ...
                if (t.drop) {
                    ...
                    this.bind("initMenu:after", function () {
                        ...
                        if ("string" == typeof t.position.of) {
                            ...
                            1 == a.length && (a[1] = a[0]), "hover" == a[0] && i.addEventListener("mouseenter", function () {
                                e.open()
                            }, {passive: !0}), "hover" == a[1] && e.node.menu.addEventListener("mouseleave", function () {
                                e.close()
                            }, {passive: !0})
                        }
                    ...
                    var a = function (e, a) {
                        var s, o, r, c = a[0], l = a[1], m = "x" == e ? "offsetWidth" : "offsetHeight",
                            d = "x" == e ? "left" : "top", p = "x" == e ? "right" : "bottom",
                            f = "x" == e ? "width" : "height", u = "x" == e ? "innerWidth" : "innerHeight",
                            h = "x" == e ? "maxWidth" : "maxHeight", v = null,
                            b = (s = d, i.getBoundingClientRect()[s] + document.body["left" === s ? "scrollLeft" : "scrollTop"]),
                            g = b + i[m], _ = window[u], y = n.offset.button[e] + n.offset.viewport[e];
            ...
            if (this.opts.iconbar = s(n, S.options.iconbar), n.use && (["top", "bottom"].forEach(function (t, i) {
                ...
                var i = "mm-menu_iconbar-" + n.position, a = function () {
            ...
            if (!U) {
                ...
                if (this.opts.keyboardNavigation = s(t, S.options.keyboardNavigation), t.enable) {
                    ...
                    var o = "input, select, textarea, button, label, a[href]", r = function (n) {
                        ...
                        var i = null, a = document.activeElement.closest(".mm-navbar");
            ...
            if (t.scroll && this.bind("close:finish", function () {
                ...
                window.addEventListener("scroll", function (t) {
                    for (var n = window.scrollY, a = 0; a < r.length; a++) if (r[a].offsetTop < n + i.updateOffset) {
                        if (c !== a) {
                            c = a;
                ...
                if (!e.node.indx) {
                    ...
                    var i = function (t) {
                        if (t.target.matches("a")) {
                            var n = t.target.textContent, i = _(e.node.pnls, ".mm-panel_opened")[0], a = -1,
                                s = i.scrollTop;
    ...
    window.Mmenu = S, (He = window.jQuery || window.Zepto || null) && (He.fn.mmenu = function (e, t) {
        ...
        return this.each(function (i, a) {
            if (a.mmApi) return;
            let s = new S(a, e, t), o = He(s.node.menu);
