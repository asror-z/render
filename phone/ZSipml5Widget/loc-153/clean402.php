    ...
    <script src="https://cdn.jsdelivr.net/npm/sipml@2.1.4/SIPml-api.js" type="text/javascript"> </script>
 ...
 <!--   <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.2/css/all.css">-->
    ...
    $SIPMLItem->realm = '10.10.3.153:5060';
    $SIPMLItem->impi = '402';
    $SIPMLItem->impu = 'sip:402@10.10.3.153:5060';
    $SIPMLItem->password = '402';
    $SIPMLItem->websocket_proxy_url = 'wss://10.10.3.153:8089/ws';
    $SIPMLItem->display_name = '402';
                ...
                case 'connecting': case 'connected':
                {
                    ...
                    if (e.session == oSipSessionRegister) {
                        ...
                        if (bConnected) {
                            ...
                            console.log('1111 11111 1111 111');
                            if (oNotifICall) {
                                oNotifICall.cancel();
                                oNotifICall = null;
                            }
...
<!--                        <div class="out_phone"><i class="fas fa-times"></i></div>-->
    ...
    <audio id="ringtone" loop src="https://cdn.statically.io/gh/akahon/zetsoft/bc655314/ringtone.wav"> </audio>
    <audio id="https://cdn.statically.io/gh/akahon/zetsoft/bc655314/ringbacktone.wav"> </audio>
    <audio id="https://cdn.statically.io/gh/akahon/zetsoft/bc655314/dtmf.wav"> </audio>
