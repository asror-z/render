...
var websocket_proxy_url = '{websocket_proxy_url}';
var outbound_proxy_url = '{outbound_proxy_url}';
var ice_servers = '{ice_servers}';
var enable_rtcweb_breaker = '{enable_rtcweb_breaker}';
var enable_early_ims = '{enable_early_ims}';
var enable_media_stream_cache = '{enable_media_stream_cache}';
...
var call_config = {
    ...
    enable_early_ims: enable_early_ims, // Must be true unless you're using a real IMS network
...
function dis(val) {
    ...
    $('#textPhoneNumber').attr('data-number', val);
    setTimeout(function(){
...
if (readonly === true) {
    $('#txtPhoneNumber').parent().addClass('d-none');
}else {
    $('#txtPhoneNumber').parent().removeClass('d-none');
};

if (visibled === true) {
    $('.numbers').addClass('d-none');
}else {
    $('.numbers').removeClass('d-none');
}
