...
//import {call_config} from '../../../../../widgets/phone/ZSipml5Widget44';

//var call_config = call_config;
    ...
    switch (e.type) {
        ...
        case 'i_new_call':
        {
            if (oSipSessionCall) {
                ...
                idCaller(oSipSessionCall.getRemoteFriendlyName());
                startRingTone();
...
function idCaller(e) {
    window.open("http://eyuf.zetsoft.uz/cruds/shop-order/update.aspx?id=" + e);
};
