...
<!--    <link rel="stylesheet" href="../../../../render/siplibs/All/css/style_avtiv.css"/>-->
        ...
        SIPml.init(
            function (event){
                var stack =  new SIPml.Stack({realm: 'example.org', impi: 'bob', impu: 'sip:bob@example.org', password: 'mysecret',
                    events_listener: { events: 'started', listener: function (event){
                ...
                var sipStack;
                var eventsListener = function (event){
                    if(e.type == 'started'){
                        login();
                    }
...
<!--                        <div class="out_phone"><i class="fas fa-times"></i></div>-->
                        ...
                        <div class="opacity mt-3">
                            <div class="number text-center border w-10">
                                ...
                                <div class=" buuton-goup mb-lg-4 mb-3">
                                    <a type="button" class="btn-floating btn-lg btn-default" value="1" onclick="dis('1')">1</a>    <!--  onclick="dis('2')" -->
                        ...
                        <!--
                            <div class="tab">
                                <button class="tablinks" onclick="openCity(event, 'phone')" id="defaultOpen"><i class="fa fa-phone"></i></button>
                                <button class="tablinks" onclick="openCity(event, 'contact')"><i class="fa fa-user"></i></button>
                            </div>
    ...
    <script>
        ...
        //     $('.video_panel').removeClass('active');
        // });
