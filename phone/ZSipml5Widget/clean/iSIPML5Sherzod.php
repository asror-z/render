                ...
                <div class="video_panel">
                    <div>
                        ...
                        <div id="divCallCtrl" class="span7 well" style='display:table-cell; vertical-align:middle'>
                            ...
                            <label style="
                            width: 100%;" align="center" id="txtRegStatus1"></label>
                            <!--id="txtRegStatus"-->
                    ...
                    <div class="opacity mt-3">
                        ...
                        <div class="number text-center border w-10">
                            ...
                            <!--knopkalarni ko'rsatish uchun div teglardan d-none class obtashalsa bo'ldi-->
                                <div class="dialing-animation " id="dialingAnimationDiv">
                                ...
                                <div class="calling-animation " id="callingAnimationDiv">
                                    <!--boshlang'ich holat ko'k knopka-->
                                    <button id="callBtn1" disabled class="btnCall rounded-circle py-3 mx-auto" title="Call"
                                            <!--onclick='sipCall("call-audio");-->'>
                                        <span class="btnCallInner"><i class="fas fa-phone fa-3x text-white"></i></span>
                                ...
                                <div class="answer-animation " id="answerAnimationDiv">
                            ...
                            <div class="ml-2 mr-2">
                                <div id="userInfo" class="user-info my-5 d-none">
                                    <div class="username">
