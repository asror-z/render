...
<div class="container">
    <div class="row">
        ...
        <div class="w-100 position-relative">
            ...
            <video class="video bg-dark position-absolute video-controls" controls style="bottom: 10px; right: 10px; width: 25%; box-shadow: 0px 0px 17px 0px #f5f4f4;"
        ...
        <div id="divCallCtrl" class="p-0 m-0">
            ...
            <div id='divCallOptions' class='call-options text-center'>
                ...
                <button class="btn px-3 py-2 " id="btnLocalVid"><i class="fas fa-video-slash"></i></button>
            </div>
...
<script type="text/javascript">
    ...
    $("#btnLocalVid").on("click", function () {
        $("#video_local").toggleClass('d-none');
        console.log('clicked');
    });
