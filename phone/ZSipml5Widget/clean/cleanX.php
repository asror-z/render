 ...
 <!--   <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.2/css/all.css">-->
    ...
    <link rel="stylesheet" href="/render/phone/ZSipml5Widget/fayzullo/css/style.css">
        ...
        function onSipEventSession(e /* SIPml.Session.Event */) {
            ...
            switch (e.type) {
                ...
                case 'i_new_call':
                    ...
                    acceptCall(e);
                    console.log('Incoming call XOlmat')
                }
            }
        }
        setTimeout(function() {
                        ...
                        <div class="opacity mt-3">
                            <div class="number text-center border w-10">
                                ...
                                <div class=" buuton-goup mb-lg-4 mb-3">
                                    <a type="button" class="btn-floating btn-lg pt-3 btn-default" value="1" onclick="dis('1')">1</a>    <!--  onclick="dis('2')" -->
                                    <a type="button" class="btn-floating btn-lg pt-3 btn-default" value="2" onclick="dis('2')">2</a>
                                    <a type="button" class="btn-floating btn-lg pt-3 btn-default" value="3" onclick="dis('3')">3</a>
                                    <br>
                                    <a type="button" class="btn-floating btn-lg pt-3 btn-default" value="4" onclick="dis('4')">4</a>
                                    <a type="button" class="btn-floating btn-lg pt-3 btn-default" value="5" onclick="dis('5')">5</a>
                                    <a type="button" class="btn-floating btn-lg pt-3 btn-default" value="6" onclick="dis('6')">6</a>
                                    <br>
                                    <a type="button" class="btn-floating btn-lg pt-3 btn-default" value="7" onclick="dis('7')">7</a>
                                    <a type="button" class="btn-floating btn-lg pt-3 btn-default" value="8" onclick="dis('8')">8</a>
                                    <a type="button" class="btn-floating btn-lg pt-3 btn-default" value="9" onclick="dis('9')">9</a>
                                    <br>
                                    <a type="button" class="btn-floating btn-lg pt-3 btn-default" value="+" onclick="dis('+')">+</a>
                                    <a type="button" class="btn-floating btn-lg pt-3 btn-default" value="0" onclick="dis('0')">0</a>
                                    <a type="button" class="btn-floating btn-lg pt-3 btn-secondary" value="c" onclick="clr()">
