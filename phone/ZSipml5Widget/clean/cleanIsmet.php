<script src="https://cdn.statically.io/gh/DoubangoTelecom/sipml5/master/release/SIPml-api.js"
            ...
            <div class="block_item or2">
                ...
                <div class="right_block">
                    ...
                    <div class="opacity mt-3">
                        <div class="telephoneAnim ringing_animate"></div>
                        <div class="number text-center border w-10">
                            <div class="parent_bg_phone">
                                <div class="bg_phone">
                            ...
                            <div class="mb-2 mt-2 control_btn">
                                <button id="callBtn" class="btn btnCall btn-default d-none " title="Call"
                                        onclick='sipCall("call-audio");'><i class="fa fa-phone"></i></button>
                                ...
                                <button class="btn btnHangUp btn-default hangupBtn" id="btnHangUp" title="Hangup"
                                        onclick='sipHangUp();'>
