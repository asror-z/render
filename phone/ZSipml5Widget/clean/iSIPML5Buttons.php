                ...
                <div class="video_panel d-none">
                    <div>
                        <div id="divCallCtrl" class="span7 well table align-middle">
                            ...
                            <table class="w-100 d-none">
                                <tr class="invisible">
                                    <td>
                                        <input type="text" class="w-100 h-100" id="txtPhoneNumber1" value=""
                                        ...
                                        <div class="btn-toolbar m-0 align-middle">
                                            ...
                                            <div class="btn-group">
                                                <input type="button" id="btnHangUp1"
                                                       class="btn btn-primary m-0 align-middle h-100" value="HangUp"
                                                       onclick='sipHangUp();' disabled/>   <!--id="btnHangUp"-->
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <div id="tdVideo" class="tab-video">
                                <div id="divVideo" class='div-video'>
                                    <div id="divVideoRemote" class="position-relative h-100 w-100 opacity-1">
                                        <video class="video opacity-0 bg-dark" width="100%" height="100%"
                                               id="video_remote" autoplay="autoplay"></video>
                                    </div>
                                    ...
                                    <div id="divScreencastLocalWrapper" class="ml-90 border border-dark">
                                        ...
                                        <div id="divScreencastLocal"
                                             class="previewvideo border border-0 border-dark z-index-1000">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container d-none">
                            ...
                            <div class="span4 well">
                                ...
                                <table class="w-100">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="h-100" id="txtRealm" value=""
                        ...
                        <footer>
                            ...
                            <p>
                                &copy; Zetsoft Telecom 2018-2020 <br/>
                    ...
                    <div class="opacity mt-3">
                        <div class="number text-center border w-10">
                            <div class="mb-2 mt-2 control_btn">
                                <button id="callBtn" class="btn btnCall btn1 py-2" title="Call"
                                        onclick='sipCall("call-audio");'><i class="fa fa-phone fa-2x text-success"></i></button>

                                <button id="videoBtn" class="btn btn1 py-2" onclick='sipCall("call-audiovideo");'>
                                    <i class="fas success-ic fa-video fa-2x"></i>
                                </button>

                                <button class="btn btnHangUp btn1 hangupBtn py-2" id="btnHangUp" title="Hangup"
                                        onclick='sipHangUp();'>
