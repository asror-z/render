<script src="/render/phone/ZSipml5Widget/fayzullo/release/SIPml-apiX.js"
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="text-center border">
                ...
                <button id="videoBtn" class="btn btn-sm">
        ...
        ?>
            ...
            <video class="video bg-dark" style="width: 100%; height: 40%; opacity: 0"
    ...
    function uiBtnCallSetText(s_text) {
        switch (s_text) {
            ...
            default: {
                ...
                btnCall.addClass("btn btn-primary");
