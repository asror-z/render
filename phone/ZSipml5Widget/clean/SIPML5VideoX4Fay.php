...
<div class="container">
    <div class="row">
        ...
        ?>
        <div>
        <video class="video bg-dark position-relative"
               style="width: 100%; opacity: 0; z-index: 101;"
               id="video_remote"
               autoplay="autoplay"
        ></video>


        <video class="video bg-dark position-absolute"
               controls
               style="width: 25%; bottom: 22%;left: 3%; z-index: 102;"
               id="video_local"
               autoplay="autoplay"
               muted="true"
        ></video>
