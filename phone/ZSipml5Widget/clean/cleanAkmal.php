 ...
 <!--   <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.2/css/all.css">-->
    ...
    $SIPMLItem->impi = '205';
    $SIPMLItem->impu = 'sip:205@94.158.52.244:7777';
    $SIPMLItem->password = '205';
    $SIPMLItem->websocket_proxy_url = 'wss://10.10.3.41:5060';
    $SIPMLItem->display_name = '205';
            ...
            switch (e.type) {
                ...
                case 'i_new_call':
                {
                    if (oSipSessionCall) {
                        ...
                        e.newSession.hangup(); // comment this line for
