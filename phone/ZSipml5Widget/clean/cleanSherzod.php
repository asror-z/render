...
<link rel="stylesheet" href="/render/phone/ZSipml5Widget/fayzullo/css/styleSherzod.css">
...
<script type="text/javascript">
    ...
    tmedia_session_jsep01.onSetRemoteDescriptionSuccess = function (a) {
        tsk_utils_log_info("onSetRemoteDescriptionSuccess");
        //$('#form').modal('show');


         //document.getElementById('rootModal').innerHTML = '<iframe src="/cruds/shop-order/update.aspx?id=190" width="100%" height="100vh"></iframe>';
         /*document.getElementById('rootModal').innerHTML =*/ '<?php /*$myModal */?>';
                        ...
                        <div class="number text-center border w-10">
                            ...
                            <!--knopkalarni ko'rsatish uchun div teglardan d-none class obtashalsa bo'ldi-->
                                <div class="dialing-animation">
                                    ...
                                    <button id="callBtn" class="btnCall rounded-circle py-3 px-3 mx-auto mt-5 bg-danger" title="Terminate"
                                            onclick='sipCall("call-audio");'>
                                        <span class="btnCallInner">
                                        <i class="fas fa-phone fa-2x text-white" style="transform: rotate(225deg)"></i></span>
                                    </button>
                                </div>

                                <div class="calling-animation d-none">
                                ...
                                <div class="answer-animation d-none">
                                ...
                                <div class="">
                                    ...
                                    <button class="btnHangUp hangupBtn hangUp-animation rounded-circle" id="btnHangUp" title="Hangup"
                                            onclick='sipHangUp();'>
                            ...
                            <div class="ml-2 mr-2 pt-5">
                                <div id="userInfo" class="user-info my-2">
                                    <div class="username">
                            <span class="text-bold fe-12">
                                User Name:
                            </span>
                                        <span id="userName" class="text-muted">
                                User3243
                            </span>
                                    </div>
                                    <div class="contactname mt-2">
                            <span class="text-bold fe-12">
                                Contact Name:
                            </span>
                                        <span id="contactName" class="text-muted">
                                Гость
                            </span>
                                    </div>
                                </div>
                                <div id="txtCallStatus" class="mt-2" style="height: 25px"></div>
                                ...
                                <div class=" md-form input-with-post-icon mt-lg-1">
                                    ...
                                    <input type="text" id="txtPhoneNumber" class="form-control text-center">
