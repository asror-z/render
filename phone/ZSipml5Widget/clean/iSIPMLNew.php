...
<script type="text/javascript">
    ...
    function sipCall(s_type,) {
        ...
        if (oSipStack && !oSipSessionCall && !tsk_string_is_null_or_empty(txtPhoneNumber.value)) {
            ...
            console.log(txtPhoneNumber.value + 'txtPhoneNumber');
    ...
    function sipHangUp() {
        if (oSipSessionCall) {
            ...
            timerShow.classList.add('d-none');
        ...
        switch (e.type) {
            ...
            case 'i_new_call': {
                if (oSipSessionCall) {
                    ...
                    console.log("ZETSOFT:" + sRemoteNumber);
            ...
            function openIncomingModal (event) {
                ...
                iframe.attr('src', '/agent/xolmat/update.aspx?id=' + sRemoteNumber);
                iframe.attr('height', '450px!important');
