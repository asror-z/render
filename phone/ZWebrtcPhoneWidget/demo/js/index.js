...
var setToInCall = function(){
    console.log("call Matrixx API to start call")
...
var hangUpCall = function(){
    timeoutTimer = false;
    console.log("call Matrixx API to end call")
};
...
var checkNumber = function(){
    ...
    var contactMatt = {
        name: 'Matt Sich',
        number: '123456789',
        image: 'http://s3-us-west-2.amazonaws.com/s.cdpn.io/378978/profile/profile-80_1.jpg',
        desc: 'CodePenner'
    };
