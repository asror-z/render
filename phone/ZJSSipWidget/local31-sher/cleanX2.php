        ...
        <div class="block_item">
            <div class="right_block">
                ...
                <div class=" md-form input-with-post-icon">
                    ...
                    <input type="number" id="txtPhoneNumber" class="form-control {numberInputClass} text-dark text-center">
                    <label for="txtPhoneNumber"></label>
                    <input type="number" id="orderIdInput" class="form-control {orderInputClass} text-dark text-center">
