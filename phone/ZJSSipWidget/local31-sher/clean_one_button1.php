...
<script src="https://jssip.net/download/releases/jssip-3.4.1.min.js"></script>
    ...
    if (user && pass) {
        ...
        phone.on('newRTCSession', (data) => {
            ...
            var completeSession = function () {
                ...
                setTimeout(function(){ txtRegStatus.innerHTML = 'Connected'; timer.classList.add('d-none'); }, 2000);
                checkIfEmpty();
