...
?>
<!--<link rel="stylesheet" href="/render/phone/ZJSSipWidget/Asset/light2.css">-->
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6 ">
            ...
            <div class="number text-center border h-100">
                ...
                <div>
                    ...
                    <div class=" md-form input-with-post-icon">
                        ...
                        <input type="number" id="txtPhoneNumber"
                               class="form-control {numberInputClass} text-dark text-center">
                        <label for="txtPhoneNumber"></label>
                        <input type="number" id="orderIdInput"
                               class="form-control {orderInputClass} text-dark text-center">
                        <label for="orderIdInput"></label>
                    </div>
                </div>
                <div class="button-group <?= $item->keypad ? '' : 'd-none' ?> mb-lg-4 mb-3">
                    <a type="button" class="btn-floating pt-2 fp-20 number-btn mx-1 hvr-radial-out" value="1">1</a>
                    <a type="button" class="btn-floating pt-2 fp-20 number-btn mx-1 hvr-radial-out" value="2">2</a>
                    <a type="button" class="btn-floating pt-2 fp-20 number-btn mx-1 hvr-radial-out" value="3">3</a>
                    <br>
                    <a type="button" class="btn-floating pt-2 fp-20 number-btn mx-1 hvr-radial-out" value="4">4</a>
                    <a type="button" class="btn-floating pt-2 fp-20 number-btn mx-1 hvr-radial-out" value="5">5</a>
                    <a type="button" class="btn-floating pt-2 fp-20 number-btn mx-1 hvr-radial-out" value="6">6</a>
                    <br>
                    <a type="button" class="btn-floating pt-2 fp-20 number-btn mx-1 hvr-radial-out" value="7">7</a>
                    <a type="button" class="btn-floating pt-2 fp-20 number-btn mx-1 hvr-radial-out" value="8">8</a>
                    <a type="button" class="btn-floating pt-2 fp-20 number-btn mx-1 hvr-radial-out" value="9">9</a>
                    <br>
                    <a type="button" class="btn-floating pt-2 fp-20 number-btn mx-1 hvr-radial-out" value="+">+</a>
                    <a type="button" class="btn-floating pt-2 fp-20 number-btn mx-1 hvr-radial-out" value="0">0</a>
