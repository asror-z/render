...
$(document).ready(function() {
    ...
    ctxSip = {
        ...
        // getIdentity media request refused or device was not present
        ...
        logItem : function(item) {
            ...
            let zSipHangupBtn = document.getElementById('zSipHangUp');
            zSipHangupBtn.setAttribute('data-sessionid', item.id);
    ...
    $('#sip-logitems').delegate('.sip-logitem .btnCall', 'click', function(event) {
     ...
     $('#phoneUI').delegate('.btnCall', 'click', function(event) {
         var sessionid = $(this).closest('.btnCall').data('sessionid');
         ctxSip.phoneCallButtonPressed(sessionid);
         return true;
     });
     $('#phoneUI').delegate('.btnHangUp', 'click', function(event) {
         var sessionid = $(this).closest('.btnHangUp').data('sessionid');
         ctxSip.phoneCallButtonPressed(sessionid);
         return true;
     });
    $('#phoneUI').delegate('.btnHangUp', 'click', function(event) {
    ...
    $('#sip-logitems').delegate('.btnCall', 'click', function(event) {
        ctxSip.phoneCallButtonPressed();
        // to close the dropdown
        return true;
    });
    ...
    $('#sip-logitems').delegate('.sip-logitem .btnHangUp', 'click', function(event) {
        var sessionid = $(this).closest('.sip-logitem').data('sessionid');
        console.log("Rakhimjon" + sessionid);
        ctxSip.sipHangUp(sessionid);
        return true;
    });
    $('#zSipHangUp').delegate('.btnHangUp', 'click', function(event) {
        var sessionid = $(this).closest('.sip-logitem').data('sessionid');
        console.log("Rakhimjon" + sessionid);
        ctxSip.sipHangUp(sessionid);
        return true;
    });
   /* $('#zSipHangUp').click(function(event) {
        var sessionid = $(this).closest('.sip-logitem').data('sessionid');
        ctxSip.sipHangUp(sessionid);
        return true;
        return true;
