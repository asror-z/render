...
window.onload = function() {
    ...
    if (!is_app) {
        ...
        script1.setAttribute("src", "https://theintencity.kundansingh.com/flash-network/swfobject.js");
        document.head.appendChild(script1);
        
        var script2 = document.createElement("script");
        script2.setAttribute("type", "text/javascript");
        script2.setAttribute("src", "https://theintencity.kundansingh.com/flash-network/json2.js");
        document.head.appendChild(script2);
        
        var script3 = document.createElement("script");
        script3.setAttribute("type", "text/javascript");
        script3.setAttribute("src", "https://theintencity.kundansingh.com/flash-network/flash-network.js");
