...
$(document).ready(function() {
    ...
    ctxSip = {
        ...
        logItem : function(item) {
            ...
            i  = '<div class="list-group-item sip-logitem clearfix test_uchun'+callClass+'" data-uri="'+item.uri+'" data-sessionid="'+item.id+'" title="Double Click to Call">';
    ...
    $('#phoneUI').delegate('.btnHangUp', 'click', function(event) {
        ...
        var btn = $('.test_uchun').document.data('sessionid');
