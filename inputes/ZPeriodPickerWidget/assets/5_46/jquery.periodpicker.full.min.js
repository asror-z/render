...
!function (a, b) {
    ...
    function d(c) {
        ...
        return f.onChange = [], f.validate = function () {
            ...
            var c;
            if (f.onChange.length) for (c = 0; c < f.onChange.length; c += 1) a.isFunction(f.onChange[c]) && f.onChange[c].call(f, f.get(), d, b)
            ...
            var c = d.getTime(), e = f.isValid(a) ? f.cloneTime(a) : f.parse(a);
    ...
    e.prototype.getRealOffset = function (a) {
        ...
        return this.each(function () {
            ...
            if (j || "string" != typeof b) if (j) switch (b) {
                case"stopDrag":
