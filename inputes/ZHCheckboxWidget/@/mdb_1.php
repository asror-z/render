...
<head>
  ...
  <meta content="width=device-width" name="viewport">
    ...
    <link rel="stylesheet" href="<?= Cdn ?>https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.12.1/css/all.min.css">


    <link rel="stylesheet" href="<?= Cdn ?>https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.12.1/css/v4-shims.css">
    <link rel="stylesheet" href="<?= Cdn ?>https://cdn.jsdelivr.net/npm/mdbootstrap@4.14.1/css/bootstrap.min.css">

    <link rel="stylesheet" href="<?= Cdn ?>https://cdn.jsdelivr.net/npm/mdbootstrap@4.14.1/css/mdb.min.css">

    <link rel="stylesheet" href="<?= Cdn ?>https://cdn.jsdelivr.net/npm/mdbootstrap@4.14.1/css/mdb.min.css">

    <link rel="stylesheet" href="<?= Cdn ?>https://cdn.jsdelivr.net/npm/mmenu-js@8.5.2/dist/mmenu.css">


    <script type="text/javascript" src="<?= Cdn ?>https://cdn.jsdelivr.net/npm/mdbootstrap@4.14.1/js/jquery.min.js"></script>

    <script type="text/javascript" src="<?= Cdn ?>https://cdn.jsdelivr.net/npm/mdbootstrap@4.14.1/js/popper.min.js"></script>
    <script type="text/javascript" src="<?= Cdn ?>https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.12.1/js/ALL.js"></script>
    <script type="text/javascript" src="<?= Cdn ?>https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.12.1/js/v4-shims.js"></script>
    <script type="text/javascript" src="<?= Cdn ?>https://cdn.jsdelivr.net/npm/mdbootstrap@4.14.1/js/mdb.min.js"></script>

  <link href="https://cdn.jsdelivr.net/npm/icheck@1.0.2/icheck.min.js" rel="stylesheet">
  <script src="https://cdn.jsdelivr.net/npm/icheck@1.0.2/demo/js/jquery.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/icheck@1.0.2/demo/js/custom.min.js"></script>
