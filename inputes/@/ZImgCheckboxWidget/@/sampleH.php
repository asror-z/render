...
use zetsoft\widgets\cards\ZMCardItemWidget;
...
$items = [
    ...
    1 => ['1' => "<img src='/render/inputes/ZImageCheckboxWidget/demo/demo_files/image1.jpg' class='checkable'>",
        ...
        [
            'attributes' => [
                'jsonb_2' => [
                    ...
                    'widgetClass' => ZImageCheckboxGroupWidgetH::class,
                    'options' => [
                        'data' => $val,
