    ...
    $(document).ready(function () {
        $("#kv-explorer").fileinput({
            ...
            /*resumableUploadOptions: {
                fallback: null,
                testUrl: "/core/tester/asror/upload.aspx?modelClassName=CoreInput&attribute=zfileinputwidget", // used for checking status of chunks/ files previously / partially uploaded
            ...
            .on('filebatchuploadsuccess', function (event, data) {
                ...
                console.log(event, data);
                var file = 'file';
                $('.file-caption-name').attr('value' ,'nweioncf');
                //$('#kv-explorer').val(file);
                //document.querySelector('#kv-explorer').value = 'file';
            })
