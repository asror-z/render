    ...
    $(document).ready(function () {
        $("#kv-explorer").fileinput({
            ...
            .on('fileselect', function (event, numFiles, label) {
                ...
                /*if(numfiles){
                var namefile = document.createElement('<div><input id="name" type="hidden"></div>');
                $('#filename').append(namefile);
                    console.log('Work')
                }else{
            ...
            .on('fileloaded', function (event, file, previewId, index, reader) {
                ...
                var app = document.createElement('<div> <input type="hidden" id="demo"> </div>')
                $('#file-name').append(app);
...
<script>
    ...
    $(document).ready(function () {
        $('#kv-explorer').on('change', function () {
