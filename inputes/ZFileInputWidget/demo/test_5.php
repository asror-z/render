...
<script>
    ...
    $(document).ready(function () {
        $("#kv-explorer").fileinput({
            ...
            deleteUrl: 'deleteUrl: "/core/tester/asror/delete-file.aspx?model=CoreInput&attribute=zfileinputwidget&id=3",',
            deleteExtraData: {},
            ...
            customLayoutTags: {},
            customPreviewTags: {},
            previewFileIcon: '<i class="fas fa-trash-alt"></i>',
