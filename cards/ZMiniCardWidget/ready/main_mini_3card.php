...
<div class="col-12 px-1">
    <a href="<?= $categoryUrl ?>" class="text-dark">
        <div class="position-relative hoverable rgba-grey-slight rounded-lg">
            <div class="cards-status position-absolute d-flex align-items-center" style="right: 0; top: 10%">
            ...
            <div class="row">
                <div class="cards-container m-3 px-2 py-4 w-100">
                    ...
                    <div class="row">
                        ...
                        $products = Az::$app->market->product->productByStatus(457, ProductItem::statuses['new'], 3);
