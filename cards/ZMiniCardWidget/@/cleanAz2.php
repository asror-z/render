...
<div class="card text-center p-2 {cardclass}">
    ...
    <div class="card-body p-">
        ...
        <div id="input-<?= $item->id ?>" class="touch-main <?= $item->cart_amount > 0 ? " " : "d-none" ?>">
            <div class="touch-main-children d-flex justify-content-center align-items-center">
                <div>
                    <?
...
<script>
    $(".cartsvalue").change(function(){
        console.log('ok');
        //var amount=$(".cartsvalue").val();
        //var catalogId = $('.add-card-'+id).attr('toAjax');
       /* $.ajax({
            url: '/core/product/setToCart.aspx',
            method: 'GET',
            data: {
                catalog_id:5, //catalogId,
                amount: amount,
            },
