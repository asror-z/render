...
<div class="d-flex horizontal-card p-4">
    ...
    <div class="col-md-4 p-1">
        <img width="auto" height="250px"
             src="https://www.isa-aydin.com/wp-content/uploads/2020/04/product-on-white-sample-4.jpg?x96595"
             class="image-horizontal-item " alt="">
    </div>
    ...
    <div class="col-md-8 horizontal-main">
        ...
        <div class="row col-md-12 horizontal-card-bottom position-absolute left-0 mb-3">
            ...
            <div class="col-md-5 w-100 ml-auto mb-2">
                <button class="w-100 border border-0 bg-success p-2 rounded text-white fz-20 addtocard" id="addcard"><i
                            class=""></i>Добавить в корзину
                </button>
                <div class="inputhide">
