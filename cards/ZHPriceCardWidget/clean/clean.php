    ...
    <div class="row p-2">
        <div class="col-md-8 mt-2 ">
            ...
            <div class="">
                ...
                <div id="star-<?= $company->id ?>" class="d-flex mt-2">
                    <?
        ...
        <div class="col-md-4 ">
            ...
            <div class="d-flex align-items-center">
                <div class="align-items-center">
                    <del><h6 class="text-muted mb-0"><?
                            ...
                            echo number_format($company->price_old, 2, '.', ',');
            ...
            <h4>
                ...
                echo number_format($company->new_price, 2, '.', ',');
                if ($company->currencyType === ProductItem::currencyType['after']) {
                    echo $company->currency . ' ';
                }
            ...
            <div>
                            <span class="text-muted">Цвет товара:красный</span>
            </div>
            <div>
                <span class="text-muted">47 человек купили этот товар</span>
            </div>
                    ...
                    <div class="d-flex touch-main-children ">
                        <div class="d-flex parent-clear w-50">
                            ...
                            echo ZKTouchSpinWidget::widget([
                                ...
                                'config' => [
                                    'min' => '0',
                                    'buttonup_txt' => '<i class="fas fa-plus p-2"></i>',
                                    'buttondown_txt' => '<i class="fas fa-minus p-2"></i>',
...
JS,
                        ...
                        <div class="v-card-clear-add pt-2" data-catalog-id="<?= $company->catalogId ?>"
