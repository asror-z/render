        ...
        <div class="col-lg-8 col-md-12">
            <div class="row">
                ...
                <div class="col-lg-12 d-flex justify-content-between">
                    ...
                    <div class="col-lg-5 sizes-prod w-25">
                        <p class="size fp-20">размер</p>

                        <div class="d-flex">
                            <button type="button" class="btn pt-1 pb-1 pr-3 pl-3 fp-18 btn btn-outline-secondary">8
                            </button>
                ...
                <div class="col-sm-6 d-flex justify-content-end  pl-sm-5 ">
                    ...
                    <div class="size-price d-flex justify-content-end align-items-end">
                        ...
                        <div class="price-prod">
                            <p class="fp-18"><span class="price-card h2 pr-2 text-success fp-35">140 890</span> сум
                                за 1
                                шт</p>
                            <button type="button" class="btn btn-success button-bg-color mt-3 pr-5 pl-5 fp-13">
                                добавить
                                в
                                корзину
                            </button>
