...
?>
        ...
        <div class="col-lg-3 col-sm-12 col-md-6 v-card pb-4 zcol h-100">
            <div class="card w-100 v-card h-100 horizontal-vertical-card" data-product-id="<?= $item->id ?>"
                ...
                <img src="https://images.pexels.com/photos/1095550/pexels-photo-1095550.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" <?= $item->url ?> class="h-auto position-relative overflow-hidden zvertical-card" alt="">
                <span style="right: 0; bottom: 45%"
