        ...
        <div class="card m-2 col-3 p-0">
            ...
            <div class="position-relative overflow-hidden">
                ...
                <span style="right: 2%; top: 4%"
                      class="<? echo $discountHidden ?> position-absolute ml-auto danger-color pl-2 pr-2 py-2 mr-2 text-white rounded fe-10">
                <? echo $discount ?> %
                    <div style="right:-4%; top: 2%"
                         class="<? echo $newHidden ?>position-absolute ml-auto green-bg-color text-white rounded-left rounded-pill fe-08  py-1 pl-lg-3 pr-xl-5 pl-2 pr-4">
                        New
                    </div>
            </span>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex mt-1">
                        ...
                        <a href="#" role="button"
                           onclick="add_compare_list(<? echo $itemProductId ?>, $(this),false)"><i
                                    class="fa fa-chart-bar grey-text h5 <? echo $compareActive ?>"></i></a>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between">
                    <div>
                        <div class="d-flex flex-wrap">
                            <div class="text-muted d-flex align-items-center"><? echo $itemBeforeCurrency ?></div>
                            <div class="text-success h4"><? echo $itemPrice ?></div>
                            <div class="text-muted d-flex align-items-center"><? echo $itemAfterCurrency ?> за
                                1 <? echo $itemMeasure ?></div>
                        </div>
            ...
            <button id="add-cart-<? echo $id ?>" class="btn button-bg-color text-white add-cart <? echo $btnHidden ?>">
                Добавить в корзину
            </button>
