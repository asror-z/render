...
<div class="card m-2">
    ...
    <a href="#" class="btn button-bg-color text-white <?= !$item->is_multi ? 'd-none' : '' ?>">Добавить в корзину</a>
...
HTML: '' ?>
    ...
    if ($item->is_multi)
        echo $this->require( '/render/cards/ZVMarketWidget/block/addToCardBtn.php');
