...
$item = Az::$app->market->product->allProducts(457, null, 0, 10, ['price', '-name']);
...
if ($item === null)
    return $this->require( '/render/cards/ZVMarketWidget/empty/main.php');
...
?>
                 <div class="col-md-6 col-lg-4 col-xl-<?=$col?> v-card pb-4 <?=$class?>">
                    <div class="card w-100 v-card h-100 horizontal-vertical-card" data-product-id="<?= $item->id ?>"
                        ...
                        <a href="<?= $item->url ?>" class="position-relative overflow-hidden zvertical-card"
                           style='background-image: url("<?= $item->images[0] ?>"); background-size: 100% 100%; height: 175px;'>
                            ...
                            <div class="position-absolute" style="right: -5%; top: 5%">
                                ...
                                <? if (in_array(ProductItem::statuses['new'], $item->status)  &&  !in_array(ProductItem::statuses['sale'],$item->status) && !$item->is_multi) { ?>
                                    <span style="right: 2%; top: 2%"
                                          class="position-absolute rounded-left green-bg-color p-1 mr-3 text-white rounded fe-08">
                  New
                </span>
                                <? } ?>
                            </div>
                  ...
                  <?= $item->discount ? $item->discount : '' ?> %
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                              ...
                              <!--  <div class="text-muted card-text mt-1"><?/*= Az::l('Артикул') */?>: <?/*= $item->barcode */?></div>-->
                            </div>
                                ...
                                <div class="w-75">
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <? if ($item->currencyType == ProductItem::currencyType['after']) { ?>
                                            <div class="text-muted d-flex align-items-center ml-2">
                        ...
                        <div class="mx-2 footer-main">
                            ...
                            if (!$item->is_multi || !$isCommon) : ?>
                                <button id="add-card-<?= $item->id ?>"
                                        class="mx-0 w-100 add-card btn button-bg-color text-white <?= $item->cart_amount > 0 ? "d-none" : "" ?>"
