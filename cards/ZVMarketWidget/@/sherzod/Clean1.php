...
<div class="card-group">
    ...
    <div class="card m-2">
        ...
        <div class="position-relative overflow-hidden">
            ...
            <span style="right:-4%; top: 2%" class="position-absolute ml-auto red-bg-color text-white rounded-left rounded-pill fe-08  py-1 pl-lg-3 pr-xl-5 pl-2 pr-4">
                Sale
            </span>
...
-->
    ...
    <div class="card m-2 overflow-hidden">
        ...
        <div style="right:-4%; top: 2%" class="position-absolute ml-auto green-bg-color text-white rounded-left rounded-pill fe-08  py-1 pl-lg-3 pr-xl-5 pl-2 pr-4">
                New
            </div>
        <img src="https://images.pexels.com/photos/461198/pexels-photo-461198.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="card-img-top" alt="...">
        <div class="card-body">
