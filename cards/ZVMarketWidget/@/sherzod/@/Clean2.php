...
<div class="card-group">
    <div class="card m-2">
        ...
        <div class="position-absolute d-flex pt-2 justify-content-between w-100 align-items-center">
            <div class="ml-2">
                <?
            ...
            <div class="ml-auto danger-color pl-4 pr-5 py-2 text-white rounded-left rounded-pill fe-15">
                Sale
            </div>
        </div>
...
-->
    ...
    <div class="card m-2 overflow-hidden">
        ...
        <span style="right: -5%; top: 2%" class="position-absolute ml-auto green darken-2 pl-4 pr-5 py-2 text-white rounded-left rounded-pill fe-15">
                New
            </span>
        <img src="https://images.pexels.com/photos/461198/pexels-photo-461198.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="card-img-top" alt="...">
        <div class="card-body">
