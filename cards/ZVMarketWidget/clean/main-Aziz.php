...
?>
    <div class="col-12 col-sm-6 col-md-<?= $col ?> col-12 v-card pb-2 zcol h-100">

        <div class="card w-100 v-card h-100 horizontal-vertical-card" data-product-id="<?= $item->id ?>" data-cart-amount="<?=$item->cart_amount?>">
