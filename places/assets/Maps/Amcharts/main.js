...
// Set up click events
        worldPolygon.events.on("hit", function(ev) {
            ...
            /*   alert(map.value);
               $('#stependiant').html(['rad0']);*/
          /* $('#myModal').modal();*/

            for (var key in countries){
               /* console.log(key, countries[key].maps);*/

                    if (countries[key].maps[0]){
                       /* console.log(countries[key].maps[0])*/
                       if (map === countries[key].maps[0]){
                           $('#mymodaltitle').text(countries[key].country);
                           $('#myModal').modal();
                       }
                    }
