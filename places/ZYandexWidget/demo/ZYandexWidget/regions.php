...
<head>
    ...
    <script src="https://api-maps.yandex.ru/2.1-dev/?lang=en_US&amp;apikey=5fb7da25-bc18-4612-b304-83ea2266c510" type="text/javascript"></script>
...
<script>
    ...
    function init() {
        ...
        regionControl.events.add('statechange', function (e) {
            console.log(event.get('target').get('values'));
        });
    }
