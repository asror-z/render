    ...
    function init() {
        var myMap = new ymaps.Map('map', {
            ...
            myPoints = [
                ...
                { coords: [41.32, 69.22], text: 'Parking garage' },
                { coords: [41.32, 69.22], text: 'House' },
                { coords: [41.32, 69.22], text: 'Laundry' },
                { coords: [41.32, 69.22], text: 'Stadium' },
                { coords: [41.32, 69.22], text: 'Train station' }
            ];
