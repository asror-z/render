...
// add a marker in the given location
        ...
        function simulateGeolocation() { /* called every 30 secs and sets the location to a different location close enough to route to */
        ...
        {
            if ( prev_lat && prev_lng ) // if both defined then this isn't the first
            {
                console.log('1');
            } else {  // otherwise this is the first call to animate
