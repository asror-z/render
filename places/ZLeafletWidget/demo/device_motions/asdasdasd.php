...
<head>
    ...
    <link   defer rel="stylesheet" href="http://cdn.leafletjs.com/leaflet/v1.1.0/leaflet.css" />
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <script defer src="http://cdn.leafletjs.com/leaflet/v1.1.0/leaflet-src.js"></script>
    <script src="/render/places/ZLeafletWidget/demo/device_motions/leaflet.rotatedMarker.js"></script>
    <script>
