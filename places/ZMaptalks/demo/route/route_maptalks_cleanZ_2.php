...
<body>
    ...
    <script>
        ...
        function success(data) {
            ...
            var coords = [];
            var arrI = []
            fetch('https://api.mapbox.com/directions/v5/mapbox/driving/69.286551%2C41.344058%3B69.298004%2C41.363308?alternatives=true&geometries=geojson&steps=true&access_token=' + apiKey)
                ...
                console.log('dataaa')
                        ...
                        for(var j=0; j<coords.length; j++){
                            var inRoute= data.routes[0].legs[j].steps
        ...
        navigator.geolocation.watchPosition(success, error, options);
          /*https://api.mapbox.com/directions/v5/mapbox/driving/69.286551%2C41.344058%3B69.298004%2C41.363308?alternatives=true&geometries=geojson&steps=true&access_token=YOUR_MAPBOX_ACCESS_TOKEN*/
