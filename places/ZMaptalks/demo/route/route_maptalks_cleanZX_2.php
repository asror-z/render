...
<body>
    ...
    <script>
        ...
        var coords = [];
        var arrI = []
        fetch('https://api.mapbox.com/directions/v5/mapbox/driving/69.286551,41.344058;69.298004,41.363308?geometries=geojson&access_token=' + apiKey)
        ...
        var lngLat = point.getCurrentPosition();
