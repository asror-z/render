...
<script>
    ...
    var coords = [];
    fetch('https://router.project-osrm.org/route/v1/driving/69.286551,41.344058;69.298004,41.363308?overview=false&geometries=geojson&alternatives=true&steps=true')
        ...
        .then(data => {
            ...
            for (var j = 0; j < coords.length; j++) {
                ...
                document.querySelector('#infoText').innerHTML += data.routes[0].legs[0].steps;
