...
<body>
    ...
    <div id="infoRoute" class="row infoRoute">
        ...
        <div id="infoRouteTime" class="col-md-12">
            <div class="row">
                <div id="infoRouteChild" class="col-md-9"></div>
                <div class="col-md-3">
    ...
    function getAPI(currentP) {
        fetch(`https://router.project-osrm.org/route/v1/driving/${currentP};${latLongFinish}?overview=false&geometries=geojson&alternatives=true&steps=true`)
            ...
            .then(data => {
                ...
                infoRouteChild.innerHTML = `<div class='timeDiv'><label class='timeLabel'> ${duration}  ${isMinutes} </label></div><div class='distanceDiv'><label class='distanceLabel'>дистанция: ${distance}  ${isMeters}</label></div>`;
                ...
                for (var j = 0; j < coords.length; j++) {
                    ...
                    if (modifier == undefined || modifier == null) {
                        ...
                        dataDiv.innerHTML += "<div class='col-md-10 instructionsLabel'>" + updatedType + " " + adressName + "<br/>" + distancePerCoordinate + " " + stepIsMeters + "</div>" +  "<div class='col-md-2 iconsDiv'>" + turnTypeImage + "</div>";
                        ...
                        dataDiv.innerHTML += "<div class='col-md-10 instructionsLabel'> " + updatedManeuver + " " + adressName + "<br>" + distancePerCoordinate + " " + stepIsMeters + "<span class='d-none'>" +  stepPosition + "</span>" + "</div>" + "<div class='col-md-2 iconsDiv'>" + modifierImage + "</div>";
