            ...
            .then(data => {
                ...
                for (var j = 0; j < coords.length; j++) {
                    ...
                    if (modifier == undefined || modifier == null) {
                        ...
                        dataDiv.innerHTML += "<div class='col-md-2 iconsDiv'>" + modifierImage + "</div>" + "<div class='col-md-10 instructionsLabel'> " + updatedManeuver + " " + adressName + "<br>" + distancePerCoordinate + " " + stepIsMeters + "<span>" +  stepPosition + "</span>" + "</div>";
                ...
                currentDiv.addEventListener('click', function (event) {
                    ...
                    //let clickedDiv = event.toElement.lastChild.innerText;
