...
<script type="text/javascript" src="/render/places/ZMaptalks/demo/assets/js/ru_I.js"></script>
...
<script>
    ...
    //getAPI(lt)
    map.addEventListener('animateinterrupted', function () {
        ...
        fetch(`https://router.project-osrm.org/route/v1/driving/${currentP};${latLongFinish}?overview=false&geometries=geojson&alternatives=true&steps=true`)
            ...
            .then(data => {
                ...
                for (var j = 0; j < coords.length; j++) {
                    ...
                    var direction = data.routes[0].legs[0].steps[j].maneuver.bearing_after;
                    var azimuth = null;
