...
//end|XakimjonErgashov|2020-10-17
...
<script>
    ...
    var resolutions = [];
    var speechButton = document.querySelector('#toRoad');
    ...
    function success(data) {
        ...
        //Start ZoirjonSobirov ||27.10.2020
    ...
    function getAPI(currentP) {
        fetch(`https://router.project-osrm.org/route/v1/driving/${currentP};${latLongFinish}?overview=false&geometries=geojson&alternatives=true&steps=true`)
            ...
            .then(data => {
                var mss = 'Двигайтесь в западном направлении Тахир улица';
                ...
                for (var j = 0; j < coords.length; j++) {
                    ...
                    if (coolDat.length === 0) {
                        coolDat = updatedManeuver + " " + adressName;
                        console.log(coolDat)
                    } else {
                        console.log("coolDat")
                ...
                //start ZoirjonSobirov || 29.10.20
                if ('speechSynthesis' in window) {
                    console.log(typeof(coolDat))
                    console.log("coolDat");
