    ...
    'rows' => [
        ...
        [
            'attributes' => [
                ...
                'jsonb_10' => [
                    'type' => Form::INPUT_WIDGET,
                    'widgetClass' => \zetsoft\widgets\places\ZGoogleReadyNavigationWidget27J::className(),
                    'options' => [
                        'config' => [
                            'data' => "service.aspx?namespace=maps&service=MatrixGoogle&method=widgetData&args=''",
                            'height'                 =>500,
                            'width'                  =>800,
