...
use zetsoft\widgets\places\ZGoogleDbWidgetZ;
use zetsoft\widgets\places\ZGoogleReadyWidgetA;
use zetsoft\widgets\places\ZGoogleReadyWidgetD;
use zetsoft\widgets\places\ZGoogleReadyWidgetG;
    ...
    'rows' => [
        ...
        [
            'attributes' => [
                ...
                'jsonb_10' => [
                    'type' => Form::INPUT_WIDGET,
                    'widgetClass' => ZGoogleReadyWidgetA::className(),
                    'options' => [
                        'config' => [
                            'height'                 => 500,
                            'width'                  => 800,
