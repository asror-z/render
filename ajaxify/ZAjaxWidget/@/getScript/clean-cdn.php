...
<head>
    ...
    <meta name="csrf-token"
          content="3OSfDL7VOhiSSxdaKc6GW2I7BTZTyPbZeFte-P-OieqD0eVOyKJuQaM_TTFhtswYCQpyXACunJ43KzjOkPrT2w==">
    <title>Виджеты</title>
    ...
    <link rel="stylesheet"
          href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.12.1/css/v4-shims.min.css">
    ...
    <script type="text/javascript"
            src="https://cdn.jsdelivr.net/npm/bootstrap@4.4.1/dist/js/bootstrap.bundle.js"></script>
...
<div id="yii-debug-toolbar" data-url="/debug/default/toolbar?tag=5e6b7cb514741" style="display:none"
...
<script>(function () {
        ...
        function showToolbar(toolbarEl) {
            var barEl = toolbarEl.querySelector(barSelector),
                ...
                blockEls = function () {
                    console.log("asdasda",blockSelector);
                    if(blockSelector){
                        return barEl.querySelectorAll(blockSelector);
                    }else{
                        return null;
                    }
                },
...
<script>jQuery(function ($) {
        $(document).ready(function () {
            $("#coreinput-string_2").fileinput({
                ...
                deleteUrl: "/core/widgettest/delete-file.aspx?modelClassName=CoreInput&attribute=string_2&id=",
                deleteExtraData: {},
                ...
                uploadUrl: "/core/widgettest/upload.aspx?modelClassName=CoreInput&attribute=string_2",
                uploadUrlThumb: "",
                uploadAsync: false,
                uploadParamNames: {
