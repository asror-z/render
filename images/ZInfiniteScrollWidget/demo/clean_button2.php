...
<p>
    <button class="view-more-button border">View more</button>
</p>
...
<script>
    ...
    function getPenPath() {
        ...
        if ( slug ) {
            return '/core/tester/asror/main.aspx?path=render/images/ZInfiniteScrollWidget/clean/demo/clean_button.php' + slug;
        }
    }
