...
if ("undefined" != typeof responsiveVoice) console.log("ResponsiveVoice already loaded"), console.log(responsiveVoice); else var ResponsiveVoice = function () {
    ...
    a.responsivevoices = [{
        ...
        name: "Czech Female", flag: "cz", gender: "f", voiceIDs: [101, 100, 102,
            197, 103]
        ...
        name: "Spanish Female",
        flag: "es", gender: "f", voiceIDs: [19, 16, 17, 18, 20, 76, 174, 207, 15]
    }, {
        ...
        name: "Greek Male", flag: "gr",
        gender: "m", voiceIDs: [163], deprecated: !0
    ...
    a.voicecollection = [{name: "Google UK English Male"}, {name: "Agnes"}, {name: "Daniel Compact"}, {name: "Google UK English Female"}, {
        ...
        lang: "hu", fallbackvoice: !0, service: "g2"
        ...
        {name: "hi-IN", rate: .25}, {name: "Fallback Hindi", lang: "hi", fallbackvoice: !0}, {
            ...
            fallbackvoice: !0,
            service: "g2"
        }, {name: "Daniel"}, {name: "Monica"}, {name: "Amelie"}, {name: "Anna"}, {name: "Alice"}, {name: "Melina"}, {name: "Mariska"}, {name: "Yelda"}, {name: "Milena"}, {name: "Xander"}, {name: "Alva"},
        {name: "Lee Compact"}, {name: "Karen"}, {
            ...
            name: "Fallback Armenian", lang: "hy", fallbackvoice: !0,
            service: "g2"
        ...
        }, {name: "Raquel Compact"}, {name: "Luciana"}, {name: "pt-BR", rate: .25},
        {
            ...
            lang: "es-419", fallbackvoice: !0, service: "g2"
            ...
            name: "sv-SE",
            rate: .25
        }, {name: "Simona Compact"}, {name: "Ioana"}, {name: "ro-RO", rate: .25}, {name: "Kyoko"}, {name: "Lekha"},
        {name: "Ting-Ting"}, {name: "Yuna"}, {name: "Xander Compact"}, {
            name: "nl-NL",
            rate: .25
        }, {
            ...
            name: "Hungarian Male",
            lang: "hu", fallbackvoice: !0, service: "g1", voicename: ""
            ...
            name: "Damayanti",
            lang: "id-ID"
        }, {name: "Alice", lang: "it-IT"}, {name: "Kyoko", lang: "ja-JP"}, {
            name: "Yuna",
            lang: "ko-KR"
    ...
    a.cache_ios_voices = [{
        ...
        voiceURI: "pl-PL",
        lang: "pl-PL"
    }, {name: "de-DE", voiceURI: "de-DE", lang: "de-DE"}, {name: "nl-NL", voiceURI: "nl-NL", lang: "nl-NL"}, {
        name: "id-ID", voiceURI: "id-ID",
        lang: "id-ID"
    ...
    a.cache_ios9_voices = [{
        ...
        name: "Anna", voiceURI: "com.apple.ttsbundle.Anna-compact",
        lang: "de-DE", localService: !0, "default": !0
    }, {
        name: "Melina",
    ...
    a.fallbackServicePath = "https://code.responsivevoice.org/" + (a.tstCompiled() ?
    ...
    a.speak = function (b, c, f) {
        if (a.iOS9 && !a.iOS9_initialized) console.log("Initializing ios9"), setTimeout(function () {
            ...
            for (g = 0; g < h.length; g++) if (a.fallbackMode) {
                ...
                var d = a.selectBest([e.collectionvoice.pitch, e.systemvoice.pitch, 1]),
                    k = a.selectBest([a.iOS9 ? 1 : null,
                        e.collectionvoice.rate, e.systemvoice.rate, 1]),
                    l = a.selectBest([e.collectionvoice.volume, e.systemvoice.volume, 1]);
                null != f && (d *= null != f.pitch ? f.pitch : 1, k *= null != f.rate ? f.rate : 1, l *= null != f.volume ? f.volume : 1);
                d /= 2;
                k /= 2;
                l *= 2;
                ...
                d = a.fallbackServicePath + "?t=" + encodeURIComponent(h[g]) + "&tl=" + (e.collectionvoice.lang || e.systemvoice.lang || "en-US") + "&sv=" + (e.collectionvoice.service || e.systemvoice.service || "") + "&vn=" + (e.collectionvoice.voicename ||
                    e.systemvoice.voicename || "") + "&pitch=" + d.toString() + "&rate=" + k.toString() + "&vol=" + l.toString();
            ...
            } else d = new SpeechSynthesisUtterance, d.voice = e.systemvoice, d.voiceURI = e.systemvoice.voiceURI, d.volume = a.selectBest([e.collectionvoice.volume, e.systemvoice.volume, 1]), d.rate = a.selectBest([a.iOS9 ? 1 : null, e.collectionvoice.rate, e.systemvoice.rate, 1]), d.pitch = a.selectBest([e.collectionvoice.pitch,
    ...
    a.mapRVs = function () {
        for (var b = 0; b < a.responsivevoices.length; b++) for (var c = a.responsivevoices[b], f = 0; f < c.voiceIDs.length; f++) {
    ...
    a.Dispatch = function (b) {
        if (a.hasOwnProperty(b +
            ...
            for (var c = a[b + "_callbacks"], f = 0; f < c.length; f++) c[f]();
            return !0
        }
    ...
    "complete" ===
    document.readyState ? a.init() : document.addEventListener("DOMContentLoaded", function () {
        a.init()
    });
