...
function clickTrigger() {
    ...
    $('[data-action^="click-trigger"]').click(function (e) {
        ...
        if ($(this).parent().parent().parent().data("action") != "click-target" && $(this).parent().parent().parent().parent().parent().data("action") != "click-target") {
            ...
            $(this).parent().siblings().children('[data-action^="click-target"]').slideUp('fast', function () {
                calculateContentHeight();
            });
...
function specialViewRead() {
    ...
    $(".no-propagation").click(function (e) {
        ...
        $("#fontSizer").slider({
            min: min, max: max, range: "min", slide: function (e, n) {
                setFontSize(n.value), changeSliderText("fontSizer", n.value)
            }, change: function (e, n) {
    ...
    void 0 !== e && ($("#fontSizer").slider("value", e), setFontSize(e), changeSliderText("fontSizer", e)),
        $("#zoomSizer").slider({
            min: minzoom,
            max: maxzoom,
            range: "min",
            slide: function (e, n) {
                setzoomSizer(n.value), changeSliderTextZoom("zoomSizer", n.value)
            },
            change: function (e, n) {
            }
        });
    ...
    void 0 !== n && ($("#zoomSizer").slider("value", n), setzoomSizer(n), changeSliderTextZoom("zoomSizer", n))
